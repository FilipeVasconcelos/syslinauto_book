\begin{landscape}
    ...
    \includegraphics[width=0.5\textwidth]{figtikz/1-1.pdf}}} 
    {\mysize 
    \[
    ...
    \raisebox{-.5\height}{\resizebox{\lctmp}{!}{
    \includegraphics[width=0.5\textwidth]{figtikz/1-2.pdf}}} 
    {\mysize 
        \[ 
    s(t)=\dfrac{t}{\tau^2}e^{-\frac{t}{\tau}}
        \]} &  
    \raisebox{-.5\height}{\resizebox{\lctmp}{!}{
    \includegraphics[width=0.5\textwidth]{figtikz/1-3.pdf}}} 
    {\mysize 
        \[
    ...
    Réponse indicielle &  
    \raisebox{-.5\height}{\resizebox{\lctmp}{!}{
    \includegraphics[width=0.5\textwidth]{figtikz/2-1.pdf}}} 
    {\mysize 
        \[
    s(t)=1+\dfrac{1}{\tau_1-\tau_2}\left(\tau_2e^{-\frac{t}{\tau_2}}
        ...
        \]} &  
    \raisebox{-.5\height}{\resizebox{\lctmp}{!}{
    \includegraphics[width=0.5\textwidth]{figtikz/2-2.pdf}}} 
    {\mysize 
        \[
    s(t)=1-e^{-\frac{t}{\tau}}-\dfrac{t}{\tau}e^{-\frac{t}{\tau}}
        \]} &  
    \raisebox{-.5\height}{\resizebox{\lctmp}{!}{
    \includegraphics[width=0.5\textwidth]{figtikz/2-3.pdf}}} 
    {\mysize 
        \[
