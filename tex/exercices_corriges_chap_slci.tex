...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/fonction_e2-exercices_corriges-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
\[
e_2(t)=
...
\[
    E(p)=E_3(p)+e^{-p} E_4(p)
        = \dfrac{1}{p}-\dfrac{1}{p^2}+\dfrac{e^{-p}}{p^2} +
          e^{-p} \left(\dfrac{1}{p^2}-\dfrac{e^{-p}}{p^2}-\dfrac{e^{-p}}{p}\right)
\]
\[
    E(p)=\dfrac{1}{p}\left(1-e^{-2p}\right)+\dfrac{1}{p^2}\left(1-2e^{-p}-e^{-2p}\right)
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/fonction_porte_decomposition-exercices_corriges-chap_slci.pdf}
    \includegraphics[width=0.8\textwidth]{figtikz/fonction_porte_decomposition2-exercices_corriges-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
...
\begin{center}
    ...
    {figtikz/laplace_schema_decharge_condensateur-exercices_corriges-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/decharge_condensateur-exercices_corriges-chap_slci.pdf}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.8\textwidth]{figtikz/masse_ressort_solution-exercices_corriges-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
%\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
