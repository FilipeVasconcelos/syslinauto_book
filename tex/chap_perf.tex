...
\begin{figure}[!h]
    ...
    \input{tikz/pert1_data-chap6.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/pert2_data-chap6.tex}
    \caption{Effet de la perturbation sur la réponse temporelle dans le cas
...
\begin{figure}[!h]
    ...
    \input{tikz/rapidite_t5pc_1-chap6.tex}
    \tikzsetnextfilename{rapidite_t5pc_2-chap6-ext}
    \input{tikz/rapidite_t5pc_2-chap6.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/rapidite_tm_1-chap6.tex}
    \tikzsetnextfilename{rapidite_tm_2-chap6-ext}
    \input{tikz/rapidite_tm_2-chap6.tex}
...
\begin{figure}
    ...
    \input{tikz/rapidite_tr_2ndordre-chap6.tex}
...
\begin{figure}[!b]
    ...
    \input{tikz/rapidite_tr_2ndordre_2-chap6.tex}
    \caption{Caractérisation de la rapidité d'un système du second ordre en
             fonction du taux d'amortissement $\xi$: par
             (bleu) le temps de réponse à 5\%,  
...
\begin{figure}[!h]
    ...
    \input{tikz/pole_dominant-chap6.tex}
