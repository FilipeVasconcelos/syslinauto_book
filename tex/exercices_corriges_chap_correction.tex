...
\SI{-90}{\degreeSI} et $\SI{0}{\degreeSI}$, le déphasage du système 
corrigé ne peut présenter une marge de phase de $\SI{60}{\degreeSI}$ que pour 
...
correcteur tel que $\SI{-90}{\degreeSI}<\phi_i<\SI{0}{\degreeSI}$. 
