...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section[Représentation graphique]{Représentation graphique de la réponse harmonique}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}[2em]
    ...
    \caption*{\index{Nyquist, Harry}\textbf{Harry Nyquist} (1889-1976), électronicien et
    ingénieur américain. Il réalisa d'importante contributions à la théorie 
    de l'information.}
\end{marginfigure}
%-------------------------------------------------------------------------------
...
\begin{marginfigure}
    ...
    \caption*{\index{Nichols, Nathaniel}\textbf{Nathaniel B. Nichols}, (1914–1997)
              ingénieur américain.}
\end{marginfigure}
%-------------------------------------------------------------------------------
...
\begin{itemize}
    ...
    \item \'Etablir la fonction de la phase $\phi(\omega)$ à partir de 
          ...
          L'argument principale est défini à l'\Cref{annexe-NC}.
...
\begin{itemize}
    ...
    \item Tracer le lieu de Nyquist, c'est à dire $\Re{H(\jw)}$ et $\Im{H(\jw)}$ 
          pour différentes valeurs de $\omega$ de 0 à $+\infty$. 
\end{itemize}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{marginfigure}
