...
\tikzsetnextfilename{sb_somm-chap2-ext}
    \begin{tikzpicture}
        ...
        \sbSortie[2.5]{S}{comp}
        \sbRelier[$S$]{comp}{S}
        \draw[-latex,thick] (comp|-0,-1.5)
                          --(comp.south)node[midway,left]{$E_2$};
    \end{tikzpicture}
\end{center}
...
\begin{center}
    ...
    \begin{tikzpicture}
        ...
        \end{scope}
%    \end{tikzpicture}
%    \tikzsetnextfilename{dep_comp4-chap2-ext}
%    \begin{tikzpicture}
...
%\begin{center}
%    \tikzsetnextfilename{exemple_11-chap2-ext}
%    \begin{tikzpicture}
%	\sbEntree{E1}
%        \sbBloc[3]{B1}{$\dfrac{H_2H_3H_4}{1+R_1H_3H_4+R_2R_3H_1H_2H_3}$}{E1}
%        \sbRelier[$P$]{E1}{B1}
%	\sbSortie[3]{S1}{B1}
%        \sbRelier[$S_{E\equiv0}$]{B1}{S1}
%    \end{tikzpicture}
%\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_boucle8-chap2-ext}
    \begin{tikzpicture}
        \gfEntree[0][-10][+]{$E$}{E}
        \gfSortie[6]{$S$}{E}{S}
