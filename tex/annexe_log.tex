...
\begin{tikzpicture}
    ...
    \draw[blue,ultra thick,latex-latex] (0,0.75) -- 
    node[above] {$\Delta=10$} (5,0.75);
    \draw[blue,ultra thick,latex-latex] (5,0.75) -- 
    node[above] {$\Delta=10$} (10,0.75);
    \draw[red,thick] (2,-0.2) -- (2,-1.22) ;
    \draw[red,thick] (7,-0.2) -- (7,-1.2) ;
    \draw[red,ultra thick,latex-latex] (2,-0.75) -- 
    node[below] {$\Delta=10$} (7,-0.75);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \draw[blue,thick] (10,0.2) -- (10,1.2) ;
    \draw[blue,ultra thick,latex-latex] (0,0.75) -- 
    node[above] {$\alpha=10$} (5,0.75);
    \draw[blue,ultra thick,latex-latex] (5,0.75) -- 
    node[above] {$\alpha=10$} (10,0.75);
    \draw[red,thick] (2.3856062735983121,-0.2) -- (2.3856062735983121,-1.2) ;
    \draw[red,thick] (7.3856062735983121,-0.2) -- (7.3856062735983121,-1.2) ;
    \draw[red,ultra thick,latex-latex] (2.3856062735983121,-0.75) -- 
    node[below] {$\alpha=10$} (7.3856062735983121,-0.75);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \draw[blue,ultra thick,latex-latex] (0,0.75) -- 
    node[above] {$\alpha=2$} ({5*log10(2)},0.75);
    \draw[blue,ultra thick,latex-latex] ({5*log10(2)},0.75) -- 
    node[above] {$\alpha=2$} ({5*log10(4)},0.75);
    \draw[blue,ultra thick,latex-latex] ({5*log10(4)},0.75) -- 
    node[above] {$\alpha=2$} ({5*log10(8)},0.75);
    \draw[blue,ultra thick,latex-latex] ({5*log10(8)},0.75) -- 
    node[above] {$\alpha=2$} ({5*log10(16)},0.75);
    \draw[blue,ultra thick,latex-latex] ({5*log10(16)},0.75) -- 
    node[above] {$\alpha=2$} ({5*log10(32)},0.75);
    \draw[blue,ultra thick,latex-latex] ({5*log10(32)},0.75) -- 
    node[above] {$\alpha=2$} ({5*log10(64)},0.75);
\end{tikzpicture}
\end{center}
...
\begin{axis}[
    ...
    {-20*log10(sqrt(1+x*x))}; 
    \addplot[line width=2pt,red,dashed,domain=1e-3:1e0, samples=101] 
    {0};
