        ...
        \end{axis}
            ...
            \node[anchor=south west] at (pt1) {
                \begin{tikzpicture}
                    ...
                    \addplot [thick,dotted,color=black,domain=0:10, samples=501,unbounded coords=jump]{1.2*exp(-0.7*x)};
                    \addplot [thick,dotted,color=black,domain=0:10, samples=501,unbounded coords=jump]{-1.2*exp(-0.7*x)};
                    \end{axis}
                \end{tikzpicture}
            };
            ...
            \node[anchor=south west] at (pt2) {
                \begin{tikzpicture}
                    ...
                    \addplot [thick,dotted,color=black,domain=0:10, samples=501,unbounded coords=jump]{1.2*exp(-0.5*x)};
                    \addplot [thick,dotted,color=black,domain=0:10, samples=501,unbounded coords=jump]{-1.2*exp(-0.5*x)};
                    \end{axis}
                \end{tikzpicture}
            };
