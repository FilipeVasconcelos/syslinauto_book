...
\begin{marginfigure}
    ...
    \input{tikz/carte_1er-chap_model}
    }
...
\begin{figure}[!t]
    \centering
    \tikzsetnextfilename{comportement_ziegler_nichols-chap_model-ext}
    \input{tikz/comportement_ziegler_nichols-chap_model.tex}
...
\begin{figure}[!t]
    \centering
    \tikzsetnextfilename{comportement_strecj-chap_model-ext}
    \input{tikz/comportement_strecj-chap_model.tex}
...
\begin{figure}[!t]
    \centering
    \tikzsetnextfilename{comportement_broida-chap_model-ext}
    \input{tikz/comportement_broida-chap_model.tex}
