...
La pulsation permet de définir la fréquence $f=\dfrac{\omega}{2\pi}$ en \unit{}{\hertz},  
elle même liée à la période $T=\dfrac{1}{f}$ en \unit{}{\second}.
\begin{figure}[!h]
\begin{center}
...
pour l'étude des \SLCI. Celle-çi nous sera très utile pour 
la résolution des équations différentielles 
régissant nos \SLCI~et nous permettra 
...
Remarquons alors que \textbf{dériver dans le domaine temporelle consiste à multiplier par 
...
\end{bequation}
Remarquons alors que \textbf{intégrer dans le domaine temporelle consiste à diviser par $p$ 
...
\textbf{conditions initialles sont nulles}\footnote{Que l'on nomme les conditions d'Heaviside}.
