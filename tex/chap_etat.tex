...
faire le pont avec les notions présentées dans ce document. Le lecteur désirant 
approfondir ses connaissances dans cette direction est invité à se procurer 
d'autres sources (exemple~\cite{Bachelier}). 
