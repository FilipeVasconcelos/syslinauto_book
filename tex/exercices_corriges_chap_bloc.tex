...
\begin{center}
    \includegraphics
    [width=0.9\textwidth]{ex1_q1-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    \includegraphics
    [width=0.7\textwidth]{ex1_q2-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.7\textwidth]{ex1_q3-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.5\textwidth]{ex1_q4-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center} 
    \includegraphics
    [width=0.9\textwidth]{ex2_a1-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.8\textwidth]{ex2_a2-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.6\textwidth]{ex2_a3-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.6\textwidth]{ex2_a4-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{(b)}
...
\begin{center}
    \includegraphics
    [width=0.9\textwidth]{ex2_b1-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.8\textwidth]{ex2_b2-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.8\textwidth]{ex2_b3-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.6\textwidth]{ex2_b4-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{(c)}
...
\begin{center}
    \includegraphics
    [width=0.8\textwidth]{ex2_c1-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.7\textwidth]{ex2_c2-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.5\textwidth]{ex2_c3-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.6\textwidth]{ex2_c4-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{(d)}
...
\begin{center}
    \includegraphics
    [width=\textwidth]{ex2_d1-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=\textwidth]{ex2_d2-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.9\textwidth]{ex2_d3-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.8\textwidth]{ex2_d4-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=\textwidth]{ex2_d5-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    \includegraphics
    [width=0.55\textwidth]{gf_exo3_2-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
    ...
    \item $\{I_2\rightarrow V_2\rightarrow I_2\}$ 
          de gain $B_2=-\dfrac{1}{R_2Cp}$ 
\end{itemize}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.7\textwidth]{sbdt_eqdiff1-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    \includegraphics
    [width=0.6\textwidth]{sbdt_eqdiff3-exercices_corriges-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\question{\textbf{Réduire le schéma-bloc sous une forme faisant apparaître 
