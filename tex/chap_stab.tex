...
\begin{figure}[!h]
    ...
    \input{tikz/stable_1-chap_stab.tex}
...
\begin{figure}[!t]
    ...
    \input{tikz/stabilite-bibo-chap_stab.tex}
...
\begin{center}
    ...
    \input{tikz/instabilite_pompage-non_boucle-chap_stab.tex}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    ...
    \input{tikz/instabilite_pompage-chap_stab.tex}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{figure}[!h]
    ...
    \input{tikz/critere_revers_black-chap_stab.tex}
...
\centering
    ...
    \input{tikz/critere_revers_bode-chap_stab.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/marge_stabilite_nyquist-chap_stab.tex}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{marge_stabilite_bode-chap_stab-ext}
    \input{tikz/marge_stabilite_bode-chap_stab.tex}
    \caption{Représentation schématique des marges de stabilité du lieu de 
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{marge_stabilite_black-chap_stab-ext}
    \input{tikz/marge_stabilite_black-chap_stab.tex}
    \caption{Représentation schématique des marges de stabilité du lieu de 
...
\begin{marginfigure}
    ...
    \input{tikz/nyquist_ntours_5-chap_stab.tex}
...
\begin{marginfigure}
    ...
    \input{tikz/nyquist_contour-chap_stab.tex}
...
\begin{marginfigure}
    ...
    \input{tikz/bromwich_contour1-chap_stab.tex}
...
\begin{marginfigure}
    ...
    \input{tikz/bromwich_contour2-chap_stab.tex}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{nyquist_contour_image_exemple1-chap_stab-ext}
    \input{tikz/nyquist_contour_image_exemple1-chap_stab.tex}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{bromwich_contour_image_exemple1-chap_stab-ext}
    \input{tikz/bromwich_contour_image_exemple1-chap_stab.tex}
