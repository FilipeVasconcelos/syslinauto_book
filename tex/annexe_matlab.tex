...
Développé par la société The MathWorks, MATLAB permet de manipuler des matrices,
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\linewidth]{fenetre_matlab.eps}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.9\linewidth]{Current_folder.eps}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\linewidth]{Editor.eps}
\end{figure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{marginfigure}
    \centering
    \includegraphics[width=0.9\linewidth]{Workspace.eps}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.9\linewidth]{Command_Window.eps}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.9\linewidth]{reponsequelconque.eps}
