...
% ------------------------------------------------------------------------------
    \begin{center}
    \tikzsetnextfilename{sb_bloc_e1-chap_slci-ext}
    \input{tikz/sb_bloc_e1-chap_slci.tex}
    \end{center}
% ------------------------------------------------------------------------------
...
% ------------------------------------------------------------------------------
    \begin{center}
    \tikzsetnextfilename{sb_bloc_e2-chap_slci-ext}
    \input{tikz/sb_bloc_e2-chap_slci.tex}
    \end{center}
% ------------------------------------------------------------------------------
...
\begin{center}
    ...
    \input{tikz/sb_bloc_e3-chap_slci.tex}
\end{center}
% ------------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Modélisation d'un SLCI}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    ...
    \input{tikz/sinusoide-chap_slci.tex}
...
\raisebox{-.5\height}{\input{tikz/sinusoide_enp-chap_slci.tex}}
}  \\
\midrule
$\Delta\phi=\pm\pi$         
...
&
{\tikzset{external/export=false}       
\raisebox{-.5\height}{\input{tikz/sinusoide_enop-chap_slci.tex}} 
}  \\
\midrule
...
&
{\tikzset{external/export=false}       
\raisebox{-.5\height}{  \input{tikz/sinusoide_enqp-chap_slci.tex}}
}\\
\midrule
$\Delta\phi=\dfrac{\pi}{2}$ 
& \begin{tabular}{@{}c@{}}\og en quadrature de phase\fg \\ 
...
& 
{\tikzset{external/export=false}       
\raisebox{-.5\height}{\input{tikz/sinusoide_enqp2-chap_slci.tex}} 
}\\
\bottomrule
\end{tabular}
...
\begin{figure}[!h]
    ...
    \input{tikz/exp_dec-chap_slci.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/sinusoide_amortie-chap_slci.tex}
...
\begin{figure}[!t]
    ...
    \input{tikz/sol_eq_diff-chap_slci.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Lien entre la fonction de transfert et la réponse impulsionnelle}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%et de la connaissance des racines de polynômes de la fraction rationnelle définissant 
