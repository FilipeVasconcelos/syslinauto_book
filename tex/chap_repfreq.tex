...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot[ultra thick,color=black,domain=1e-2:1e2, samples=101]{-10*log10(1+x*x)};
...
\begin{axis}
    ...
    \addplot[blue,thick,domain=0.01:0.2,samples=50,-{Latex[length=3mm]}] (0,{-1/x});
    \addplot[blue,thick,domain=0.1:100,samples=50] (0,{-1/x});
    \addplot [dashed,blue,thick,domain=-100:-0.2,-{Latex[length=3mm]},samples=100](0,{-1/x});
