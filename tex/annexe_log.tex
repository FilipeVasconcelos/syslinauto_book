...
logarithme décimale. La maîtrise du calcul logarithmique est donc indispensable
...
\]
où la fonction $\ln{x}$ est la fonction logarithme népérien (c.-à-d. en base 
naturelle $e$) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/log_1-annexe_log.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/log_2-annexe_log.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/log_3-annexe_log.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
on parle d'\textbf{octave}\footnote{Pour le lecteur mélomane, cela correspond à
...
plus couramment utilisé, est définie comme un dixième de bel, et donc 
...
\]
Nous rappelons que le gain $G(\omega)$, dit naturel, est le module de la
...
différentes valeurs particulières fréquemment rencontrées dans ce cours.
%-------------------------------------------------------------------------------
\begin{table}[!t]
...
gain en décibel ce comporte comme 
\[
...
\]
Dans le cas des hautes fréquences, lorsque la pulsation est multiplié par 
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_1-annexe_log.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_2-annexe_log.pdf}
...
sur le diagramme de Bode, mais comme précédemment
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Tracé d'un diagramme de Bode avec MATLAB}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\href{https://fr.mathworks.com/help/control/ref/dynamicsystem.bode.html}
     {\texttt{bode}}.
