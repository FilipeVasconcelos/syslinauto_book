...
\begin{center}
    ...
    \input{tikz/exercices_bode_h1_gain-chap_repfreq.tex}

    \tikzsetnextfilename{exercices_bode_h1_phase-chap_repfreq-ext}
    \input{tikz/exercices_bode_h1_phase-chap_repfreq.tex}
\end{center}
%-------------------------------------------------------------------------------
(b)
\[ 
...
\begin{center}
    ...
    \input{tikz/exercices_bode_h2_gain-chap_repfreq}
    \tikzsetnextfilename{exercices_bode_h2_phase-chap_repfreq-ext}
    \input{tikz/exercices_bode_h2_phase-chap_repfreq}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    ...
    \input{tikz/exercices_bode_h3_gain-chap_repfreq}
    \tikzsetnextfilename{exercices_bode_h3_phase-chap_repfreq-ext}
    \input{tikz/exercices_bode_h3_phase-chap_repfreq}
\end{center}
%-------------------------------------------------------------------------------
