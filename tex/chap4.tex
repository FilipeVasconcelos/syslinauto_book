...
Pour étudier l'effet de l'asservissement d'un système du premier ordre 
sur les performances discutées précedemment, nous allons considérer sans
perte de généralité le schéma fonctionnel à boucle de contre réaction 
unitaire suivant :
\begin{center}
    \begin{tikzpicture}
        \sbEntree{E}
...
Considérons un procédé de fonction de transfert $H(p)$ telle que:
$$
H(p)=\dfrac{K}{1+\tau p}
$$
