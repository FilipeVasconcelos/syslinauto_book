...
\begin{figure}[!b]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/necessite_correction_chap_correction.pdf}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/bs_correction_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/correction_serie_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/correction_reaction_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/correction_serie-reaction_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
%\[
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/p_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/i_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{bequation}[ams align]
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/d_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{bequation}[ams align]
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_pi_gain_chap_correction.pdf}
    
    \includegraphics[width=0.5\textwidth]{figtikz/bode_pi_phase_chap_correction.pdf}
    \caption{Diagramme de Bode du correcteur à effet proportionnel et intégral.}
\end{figure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{center}
     \includegraphics[width=0.5\textwidth]{figtikz/pi_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_pd_gain_chap_correction.pdf}
    
    \includegraphics[width=0.5\textwidth]{figtikz/bode_pd_phase_chap_correction.pdf}
    \caption{Diagramme de Bode du correcteur à effet proportionnel et dérivé.}
\end{figure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/pd_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
    U(p)=k_p\left(1+\dfrac{1}{\tau_i p}\right)\epsilon(p)
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_avancedephase_gain_chap_correction.pdf}
    
    \includegraphics[width=0.5\textwidth]{figtikz/bode_avancedephase_phase_chap_correction.pdf}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/bode_BONC_exempleAP-chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/bode_BONC_BOC_exempleAP-chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_retarddephase_gain_chap_correction.pdf}
    
    \includegraphics[width=0.5\textwidth]{figtikz/bode_retarddephase_phase_chap_correction.pdf}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/pid_parallele_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/pid_serie_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/pid_mixte_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_retardavancedephase_gain_chap_correction.pdf}
    
    \includegraphics[width=0.5\textwidth]{figtikz/bode_retardavancedephase_phase_chap_correction.pdf}
