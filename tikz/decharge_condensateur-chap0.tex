...
\begin{tikzpicture}
    ...
    \draw[thick] (C)  -- (D);
    \draw[thick] (A)  -- (E);
    \draw[very thick,blue] (C1) -- (C2) node[blue,xshift=1em,yshift=-0.5em] {$C$};
    \draw[very thick,blue] (C3) -- (C4);
    \draw[thick] (F)  -- (G);
    \draw[thick] (G)  -- (H);
    \draw[thick] (I)  -- (H);
    \draw[thick] (J)  -- (D);
    \draw[thick] (K)  -- (C);
    \draw[very thick,red] (R1) rectangle (R2) node[yshift=-1.5em,xshift=0.75em] {$R$};% node[red] {$R$};
