...
Soient $p_1,\ldots,p_n$ les pôles d'un système stable
\footnote{À partir des résultats obtenues dans ce chapitre il est déjà clair que la stabilité
d'un système dépend également des pôles de la fonction de transfert}.
Le pôle $p_i$ est dit dominant par rapport à $p_j$ si les
valeurs absolues de leurs parties réelles vérifient la relation
suivante :
\begin{bequation}[ams align]
	|\Re{p_i}| < |\Re{p_i}|
\end{bequation}

Pour plus facilement distinguée cette notion de pôles 
dominants nous allons l'illustrer par l'étude d'une fonction 
de transfert du second ordre en régime apériodique c'est à dire
qu'elle est équivalente à deux systèmes du premier ordre en série.
Soit une telle la fonction de transfert telle que :
$$
H(p)=\dfrac{5}{(p+1)(5p+1)}
$$
Les pôles de celle-ci sont représentés sur la carte des pôles suivante :
\begin{center}
\tikzsetnextfilename{poles-chap2_ext}
