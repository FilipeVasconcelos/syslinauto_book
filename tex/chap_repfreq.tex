...
\begin{figure}[!b]
    \centering
    \tikzsetnextfilename{sche_nyquist_3-chap_repfreq-ext}
    \resizebox{.45\linewidth}{!}{\input{tikz/sche_nyquist_3-chap_repfreq.tex}}
    \tikzsetnextfilename{sche_nyquist_4-chap_repfreq-ext}
    \resizebox{.45\linewidth}{!}{\input{tikz/sche_nyquist_4-chap_repfreq.tex}}
...
\begin{figure}[!h]
    ...
    \input{tikz/sche_black-chap_repfreq.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/bode_gain_2-chap_repfreq.tex}
...
\begin{figure}[!htb]
    ...
    \input{tikz/bode_deriv_1-chap_repfreq.tex}

    \tikzsetnextfilename{bode_deriv_2-chap_repfreq-ext}
    \input{tikz/bode_deriv_2-chap_repfreq.tex}
...
\input{tikz/bode_1er_5-chap_repfreq.tex}

\tikzsetnextfilename{bode_1er_6-chap_repfreq-ext}
\input{tikz/bode_1er_6-chap_repfreq.tex}
...
\begin{figure}[!t]
    ...
    \input{tikz/bode_1er_serie_2nd_1-chap_repfreq.tex}
...
\begin{figure}[!t]
    ...
    \input{tikz/bode_2nd_1-chap_repfreq.tex}

    \tikzsetnextfilename{bode_2nd_2-chap_repfreq-ext}
    \input{tikz/bode_2nd_2-chap_repfreq.tex}
...
\begin{figure}[!t]
    ...
    %\input{tikz/bode_2nd_3-chap_repfreq.tex}

    %\tikzsetnextfilename{bode_2nd_4-chap_repfreq-ext}
    %\input{tikz/bode_2nd_4-chap_repfreq.tex}
    \tikzsetnextfilename{bode_2nd_5-chap_repfreq-ext}
    \input{tikz/bode_2nd_5-chap_repfreq.tex}
...
\begin{figure}[!htb]
    ...
    \input{tikz/gain_resonance-chap_repfreq.tex}
...
\begin{figure}[!t]
    ...
    \input{tikz/bode_exemple_1-chap_repfreq.tex}

    \tikzsetnextfilename{bode_exemple_2-chap_repfreq-ext}
    \input{tikz/bode_exemple_2-chap_repfreq.tex}
...
\begin{marginfigure}
    ...
    \input{tikz/nyquist_contour-chap_repfreq.tex}
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/nyquist_gainpur-chap_repfreq.tex}}
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/nyquist_integ-chap_repfreq.tex}}
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/nyquist_deriv-chap_repfreq.tex}}
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/nyquist_retard-chap_repfreq.tex}}
...
\begin{figure}[!hb]
    ...
    \input{tikz/nyquist_1er-chap_repfreq.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_2nd_3-chap_repfreq.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_effet_retard_1-chap_repfreq.tex}
...
%    \input{tikz/nyquist_effet_retard_2-chap_repfreq.tex}
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/black_integ-chap_repfreq.tex}}
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/black_deriv-chap_repfreq.tex}}
...
\begin{figure}[!h]
    ...
    \input{tikz/black_1er-chap_repfreq.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/black_2nd-chap_repfreq.tex}
    \tikzsetnextfilename{black_2nd_resonance-chap_repfreq-ext}
    \input{tikz/black_2nd_resonance-chap_repfreq.tex}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{repham_transitoire_1er-chap_repfreq-ext}
    \input{tikz/repham_transitoire_1er-chap_repfreq.tex}
