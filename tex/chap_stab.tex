...
\begin{axis}
    ...
    ({-\dpp*atan2(\da*x,(1-\db*x*x))},
     {-\dk*10*log10((1-\db*x*x)*(1-\db*x*x)+\da*\da*x*x)});
%    \addplot[col1,thick,domain=1e2:1e4,samples=200]  
%    ({-\dpp*atan2(\da*x,(1-\db*x*x))},
%     {-\dk*10*log10((1-\db*x*x)*(1-\db*x*x)+\da*\da*x*x)});
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \def\dk{9}
        \addplot[very thick,col4,domain=1e-2:1e2  , samples=101]
        {\dk+50-20*log10(1+10*x*x)};
        \addplot[very thick,col1,domain=1e-2:1e2  , samples=101]
        {\dk+30-20*log10(1+10*x*x)};
        \addplot[very thick,col3,domain=1e-2:1e2,samples=101]
        {\dk+10-20*log10(1+10*x*x)};
        \addplot [col3, mark = *]  coordinates 
        {(3.0077,{\dk+10-20*log10(1+10*3.0077*3.0077)})} {};
        \addplot [col1, mark = *]            coordinates 
        {(3.0077,{\dk+30-20*log10(1+10*3.0077*3.0077)})} {};
        \addplot [col4, mark = *]             coordinates 
        {(3.0077,{\dk+50-20*log10(1+10*3.0077*3.0077)})} {};
        \draw[col3,dashed] 
        (1e-2,{\dk+10-20*log10(1+10*3.0077*3.0077)}) 
        node[left] {$G(\omega_c)$} -- 
        (3.0077,{\dk+10-20*log10(1+10*3.0077*3.0077)});
        \draw[col4,dashed] (1e-2,{\dk+50-20*log10(1+10*3.0077*3.0077)}) 
        node[left] {$G(\omega_c)$} -- 
        (3.0077,{\dk+50-20*log10(1+10*3.0077*3.0077)}) ;
        \node (pt1) at (axis cs:3.0077,80) {};
        \draw[]  (1e-2,0)  node[left] {\SI{0}{\dB}} -- (1e2,0);
        \node [col3,right]  at (axis cs: 1e2, -80.0) 
        {\textbf{stable}  };                
        \node [col1          ,right]  at (axis cs: 1e2, -60.0) 
        {\textbf{critique}};                
        \node [col4           ,right]  at (axis cs: 1e2, -40.0) 
        {\textbf{instable}};                
        \end{axis}
        \begin{axis}[
        ...
        \addplot[very thick,col5,domain=1e-2:1e2, samples=101]
        {-2.5*atan2(x,1)};
        \def\ttt{0.865}
        \def\ddd{9.1}
        \addplot [col3, mark = *]  coordinates 
