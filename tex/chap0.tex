...
au paragraphe\cref{sec-signaux_usuels}
...
en trouver une solution pour un jeu de de conditions initiales données.
Les méthodes classiques de résolution d'équations différentielles 
peuvent très bien être appliquées. Cependant, celles-ci peuvent être difficiles 
à mettre en oeuvre dans le cas d'équation différentielle d'ordre élevé 
...
simplement obtenue par transformée de Laplace inverse $\laplacei{S(p)}$.
