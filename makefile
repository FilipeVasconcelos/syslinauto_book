...
clean:
	...
	rm -f figtikz/*.dpth figtikz/*.glo figtikz/*.glo-abr figtikz/*.idx figtikz/*.ist figtikz/*.log figtikz/*.md5 figtikz/*.mtc figtikz/*.mtc0 figtikz/*.slo figtikz/*.maf figtikz/*.ilg figtikz/*.ind
