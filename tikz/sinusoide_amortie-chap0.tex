    \begin{tikzpicture}
        ...
        xticklabels={},
            ...
            \addplot [very thick,color=blue,domain=-2:0, samples=11,unbounded coords=jump]{0};
            \addplot [very thick,color=blue,domain=0:4*pi, samples=501,unbounded coords=jump]{exp(-0.2*x)*sin(3.5*deg(x))};
            \addplot [dashed,very thick,color=blue,domain=0:4*pi, samples=501,unbounded coords=jump]{exp(-0.2*x)};
            \addplot [dashed,very thick,color=blue,domain=0:4*pi, samples=501,unbounded coords=jump]{-exp(-0.2*x)};
