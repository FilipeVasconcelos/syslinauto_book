...
\begin{figure}[!t]
    \centering
    \tikzsetnextfilename{1er_imp-chap3-ext}
    \begin{tikzpicture}
    \begin{axis}
...
\caption{Réponse impulsionnelle d'un système du premier ordre pour 
         ...
         (\Cref{eq-1er_imp}) avec $K=1$ et $E_0=1$.\label{fig-1er_imp}}
\end{figure}
%------------------------------------------------------------------------------
...
\begin{figure}
\centering
\tikzsetnextfilename{1er_ind1-chap3-ext}
\begin{tikzpicture}
\begin{axis}[%
...
\addplot[thick,col5,domain=0:11.5,samples=101]
{{1}};
\addplot[thick,col1,domain=0:11.5,samples=101]
{1-exp(-x)};
\addplot[thick,col2,domain=0:11.5,samples=101]
{(1-exp(-x/2))};
\addplot[thick,col3,domain=0:11.5,samples=101]
{(1-exp(-x/3))};
\addplot[thick,col4,domain=0:11.5,samples=101]
{(1-exp(-x/4))};
\addplot[thick,col6,domain=0:11.5,samples=101]
{(1-exp(-x/5))};
\legend{échelon,$\tau=1$,$\tau=2$,$\tau=3$,$\tau=4$,$\tau=5$}
\end{axis}%
\end{tikzpicture}%
\hfill
\tikzsetnextfilename{1er_ind2-chap3-ext}
\begin{tikzpicture}
\begin{axis}[
    legend style={draw=none,font=\scriptsize},
...
\addplot[thick,color=col5,domain=0:11.5, samples=101]
{{1}};%
\addplot[thick,color=col1,domain=0:11.5, samples=101]
{0.5*(1-exp(-x))};
\addplot[thick,color=col4,domain=0:11.5, samples=101]
{1-exp(-x)};
\addplot[thick,color=col3,domain=0:11.5, samples=101]
{2*(1-exp(-x))};
...
\begin{figure}
\centering
\tikzsetnextfilename{1er_ramp1-chap3-ext}
\begin{tikzpicture}
\begin{axis}[%
    legend style={draw=none,font=\scriptsize},
...
\end{tikzpicture}%
\hfill
\tikzsetnextfilename{1er_ramp2-chap3-ext}
\begin{tikzpicture}
\begin{axis}[
    legend style={draw=none,font=\scriptsize},
    legend pos=north west,
...
\begin{center}
        \tikzsetnextfilename{2nd_sb_imp-chap3-ext}
\begin{tikzpicture}
    \sbEntree{E}
...
\begin{figure}[!t]
\begin{center}
\tikzsetnextfilename{2nd_pp-chap3-ext}
...
\begin{figure}[!h]
\begin{center}
    \tikzsetnextfilename{2nd_depassement_1-chap3-ext}
    \begin{tikzpicture}
    ...
    \addplot[envelop,domain=0:20] {1+exp(-\a*x)};
    \addplot[envelop,domain=0:20] {1-exp(-\a*x)};
    \addplot[thick,domain=0:20]   {1};
    \draw[utr] (axis cs:\tu,1)  -- (axis cs:\tu,\du)  node[above] {$D_1$};
    \draw[utb] (axis cs:\td,1)  -- (axis cs:\td,\dd)  node[below] {$D_2$};
    \draw[utg] (axis cs:\ttt,1) -- (axis cs:\ttt,\dt) node[above] {$D_3$};
    \draw[utn] (axis cs:\tq,1)  -- (axis cs:\tq,\dq)  node[below] {$D_4$};
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{2nd_t5pc-chap3-ext}
    \begin{tikzpicture}
    \pgfmathsetmacro{\a}{0.2}             % amortissement xi
    \pgfmathsetmacro{\b}{0.96}            % 1-xi^2 
    \pgfmathsetmacro{\w}{0.979795897113}  % w_d=w_0 sqrt(1-xi^2)
...
\begin{figure}
\centering
\tikzsetnextfilename{rapidite_tr_2ndordre-chap3-ext}
\begin{tikzpicture}
    \begin{axis}
...
\begin{figure}[!t]
    \centering
    \tikzsetnextfilename{2nd_ramp-chap3-ext}
    \begin{tikzpicture}
    \begin{axis}
    [   legend style={draw=none},
        legend pos=outer north east,
    ...
    %entrée
    \addplot[thick,color=black,domain=0:10, samples=101]{x};
    % xi=2 apériodique 
...
%\begin{figure}
%    \centering
%    \tikzsetnextfilename{integrateur_1-chap3-ext}
%    \begin{tikzpicture}
%    \begin{axis}
%    [   name=first,
%        axis line style = thick,
...
%        label style={font=\Large},
%    ]
%    \addplot[very thick,color=col1,domain=-1:0, samples=10]{{0}};
%    \addplot[very thick,color=col1,domain=0:11.5, samples=10]{{1}};
%    \draw[dashed,very thick,col1]   (axis cs:0,0)--(axis cs:0,1);
...
%    ]
%    \addplot[very thick,color=col1,domain=-1:0,samples=10]{{0}};
%    \addplot[very thick,color=col1,domain=0:11.5,samples=10]{{x}};
%    \draw[dashed,very thick,black] (axis cs:0,0)--(axis cs:0,1);
%    \addplot[very thick,color=black,domain=-1:0,samples=10]{{0}};
%    \addplot[very thick,color=black,domain=0:11.5,samples=10]{{1}};
%    \end{axis}
%    \end{tikzpicture}
%\caption{(gauche) Réponse impulsionnelle 
%         (droite) Réponse indicielle d'un intégrateur avec $K=1$ et $E_0=1$.
%         \label{fig-integ}}
%\end{figure}
%------------------------------------------------------------------------------
