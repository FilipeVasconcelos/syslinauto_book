...
\begin{figure}
    \centering
    \tikzsetnextfilename{bode_pi_chap_correction-ext}
    \input{tikz/bode_pi_chap_correction.tex}
...
\begin{figure}
    \centering
    \tikzsetnextfilename{bode_pd_chap_correction-ext}
    \input{tikz/bode_pd_chap_correction.tex}
    \caption{Diagramme de Bode du correcteur à avance de phase.}
\end{figure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
...
\begin{figure}
    ...
    \input{tikz/bode_avancedephase_chap_correction.tex}
    \caption{Diagramme de Bode du correcteur à avance de phase.}
\end{figure}
%-------------------------------------------------------------------------------
...
\begin{figure}
    ...
    \input{tikz/bode_retarddephase_chap_correction.tex}
...
\begin{figure}
    ...
    \input{tikz/bode_retardavancedephase_chap_correction.tex}
