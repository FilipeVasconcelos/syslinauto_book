\begin{landscape}
    ...
    \raisebox{-.5\height}{\resizebox{0.95\linewidth}{!}{\input{tikz/1-1.tex}}} 
    {\mysize 
    \[
    ...
    \raisebox{-.5\height}{\resizebox{0.95\linewidth}{!}{\input{tikz/1-2.tex}}} 
    {\mysize 
        \[ 
    s(t)=\dfrac{t}{\tau^2}e^{-\frac{t}{\tau}}
        \]} &  
    \tikzsetnextfilename{2nd_rep_1_3_ext}
    \raisebox{-.5\height}{\resizebox{0.95\linewidth}{!}{\input{tikz/1-3.tex}}} 
    {\mysize 
        \[
    ...
    \raisebox{-.5\height}{\resizebox{0.95\linewidth}{!}{\input{tikz/2-1.tex}}} 
    {\mysize 
        \[
    ...
    \raisebox{-.5\height}{\resizebox{0.95\linewidth}{!}{\input{tikz/2-2.tex}}} 
    {\mysize 
        \[
    s(t)=1-e^{-\frac{t}{\tau}}-\dfrac{t}{\tau}e^{-\frac{t}{\tau}}
        \]} &  
    \tikzsetnextfilename{2nd_rep_2_3_ext}
    \raisebox{-.5\height}{\resizebox{0.95\linewidth}{!}{\input{tikz/2-3.tex}}} 
    {\mysize 
        \[
