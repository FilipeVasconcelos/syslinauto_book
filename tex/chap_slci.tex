...
\addplot[thick,color=black,domain=0:30,samples=101]{{1}};
\addplot[thick,color=cyan,domain=0:30,samples=101]
{6.25*(1-exp(-x/5))-1.25*(1-exp(-x))};
\addplot[thick,color=green,domain=0:30,samples=101]{1.25*(1-exp(-x))};
\addplot[thick,color=blue,domain=0:30,samples=101]{6.25*(1-exp(-x/5))};
