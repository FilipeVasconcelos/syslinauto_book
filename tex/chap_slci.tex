...
ou encore Marvin Minsky\index{Minsky, Marvin}.} 
...
plusieurs sorties (c.f~\Cref{fig-systeme}). On distinguera les systèmes à 
...
% ------------------------------------------------------------------------------
\begin{center}
    \tikzsetnextfilename{sb_bloc-chap1-ext}
    \input{tikz/sb_bloc-chap1.tex}
\end{center}
% ------------------------------------------------------------------------------
...
% ------------------------------------------------------------------------------
    \begin{center}
    \tikzsetnextfilename{principe_linearite-chap1-ext}
    \input{tikz/principe_linearite-chap1.tex}
    \end{center}
% ------------------------------------------------------------------------------
...
% ------------------------------------------------------------------------------
    \begin{center}
    \tikzsetnextfilename{sb_bloc_e1-chap1-ext}
    \input{tikz/sb_bloc_e1-chap1.tex}
    \end{center}
% ------------------------------------------------------------------------------
...
% ------------------------------------------------------------------------------
    \begin{center}
    \tikzsetnextfilename{sb_bloc_e2-chap1-ext}
    \input{tikz/sb_bloc_e2-chap1.tex}
    \end{center}
% ------------------------------------------------------------------------------
...
% ------------------------------------------------------------------------------
\begin{center}
    \tikzsetnextfilename{sb_bloc_e3-chap1-ext}
    \input{tikz/sb_bloc_e3-chap1.tex}
\end{center}
% ------------------------------------------------------------------------------
...
du mouvement).%, pourra selon comporter différent selon le 
%niveau de précision et/ou des hypothèses utilisées. 
...
%Nous aurons la plupart du temps à faire à des équations différentielles
%d'ordre $n\ne2$, avec un second membre ne dépendant que du signal d'entrée 
%et non de ses dérivées.
...
\begin{figure}[htb]
    \centering
    \tikzsetnextfilename{causal-chap1-ext}
...
\begin{center}
    \tikzsetnextfilename{retarde-chap1-ext}
...
\begin{figure}[!htb]
    \centering
    \tikzsetnextfilename{periodique-chap1-ext}
...
L'impulsion de Dirac\footnote{\index{Dirac, Paul}Paul Dirac, (1902-1984) 
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{dirac-chap1-ext}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{dirac_reel-chap1-ext}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{echelon-chap1-ext}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{rampe-chap1-ext}
...
\raisebox{-.5\height}{\input{tikz/sinusoide_enp-chap0.tex}}
}  \\
\midrule
$\Delta\phi=\pm\pi$         
...
&
{\tikzset{external/export=false}       
\raisebox{-.5\height}{\input{tikz/sinusoide_enop-chap0.tex}} 
}  \\
\midrule
...
&
{\tikzset{external/export=false}       
\raisebox{-.5\height}{  \input{tikz/sinusoide_enqp-chap0.tex}}
}\\
\midrule
$\Delta\phi=\dfrac{\pi}{2}$ 
& \begin{tabular}{@{}c@{}}\og en quadrature de phase\fg \\ 
...
& 
{\tikzset{external/export=false}       
\raisebox{-.5\height}{\input{tikz/sinusoide_enqp2-chap0.tex}} 
}\\
\bottomrule
\end{tabular}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{exp_dec-chap1-ext}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
La transformée de Laplace\footnote{\index{Laplace, Pierre-Simon}
...
d'Heaviside\footnote{\index{Heaviside, Oliver}Oliver Heaviside, (1850-1925), 
...
\begin{figure}[!h]
    \center
    \tikzsetnextfilename{carte-chap1-ext}
...
%    \input{tikz/pole_dominant-chap1.tex}
%    \caption{}
%\end{figure}
% ------------------------------------------------------------------------------
