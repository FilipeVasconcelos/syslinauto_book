...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/systeme-chap_slci.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{ClaudeShannon.eps}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{NorbertWiener.eps}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{MarvinMinsky.eps}
...
\`A noter que cet objectif atteint, il nous sera possible de représenter 
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/sb_bloc-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
        \begin{center}
            \includegraphics[width=0.6\textwidth]{figtikz/principe_linearite-chap_slci.pdf}
        \end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
        \begin{center}
            \includegraphics[width=0.8\textwidth]{figtikz/principe_superposition_1-chap_slci.pdf}
        \end{center}
%-------------------------------------------------------------------------------
        Notons que ceci reste vrai pour une combinaison linéaire des entrées :
%-------------------------------------------------------------------------------
        \begin{center}
            \includegraphics[width=0.5\textwidth]{figtikz/principe_superposition_2-chap_slci.pdf}
        \end{center}
%-------------------------------------------------------------------------------
...
\textbf{Un système à temps continu met en œuvre des signaux 
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/principe_invariance-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
    \item \emph{Principe de causalité :}
        ...
        \textbf{\og L’effet ne précédant pas sa cause\fg} alors 
        \textbf{\og La réponse du système ne précède pas son excitation\fg}.
        Formellement, un système est dit causal si 
...
du mouvement).
En électronique, ce sont, par exemple, les lois des nœuds et mailles (ou 
...
\begin{marginfigure}[-8em]   
    \centering
    \includegraphics[width=\textwidth]{figtikz/decharge_condensateur-chap_slci.pdf}
...
\end{align*}
%-------------------------------------------------------------------------------
Comme précédemment, on identifie formellement cette équation différentielle 
...
\restoregeometry
\captionsetup{width=0.9\linewidth,labelfont=bf}
La résolution de cette équation du mouvement permet de connaître la position 
de la masse à chaque instant connaissant la force extérieur 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/causal-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Retardé}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.8\textwidth]{figtikz/retarde-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
même au bout d'un même intervalle de temps ou période $T$. On définit alors 
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{figtikz/periodique-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.25\textwidth]{figtikz/entree_echelon-chap_slci.pdf}
    \includegraphics[width=0.25\textwidth]{figtikz/stable_echelon-chap_slci.pdf}
    \includegraphics[width=0.25\textwidth]{figtikz/instable_echelon-chap_slci.pdf}

    \includegraphics[width=0.25\textwidth]{figtikz/entree_harm-chap_slci.pdf}
    \includegraphics[width=0.25\textwidth]{figtikz/stable_harm-chap_slci.pdf}
    \includegraphics[width=0.25\textwidth]{figtikz/instable_harm-chap_slci.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{PaulDirac.eps} 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/dirac-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{figtikz/dirac_reel-chap_slci.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{figtikz/echelon-chap_slci.pdf}
...
multipliant par un échelon-unité (c.f \ref{subsec:decomp_usuels}).
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{figtikz/rampe-chap_slci.pdf}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=0.8\textwidth]{figtikz/sinusoide-chap_slci.pdf}}
...
des relations trigonométriques simples\footnote{à savoir la comptine des 
...
\begin{marginfigure}
    ...
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/exp_dec-chap_slci.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/sinusoide_amortie-chap_slci.pdf}}
...
\begin{table}[!h]
    ...
    {\tikzset{external/export=false}       
        \raisebox{-.5\height}{%
            \resizebox{\linewidth}{!}{%
                \includegraphics[width=0.8\textwidth]{figtikz/sinusoide_enp-chap_slci.pdf}
            }
        }
    }  \\
    \midrule
    ...
    {\tikzset{external/export=false}       
        \raisebox{-.5\height}{%
            \resizebox{\linewidth}{!}{%
                \includegraphics[width=0.8\textwidth]{figtikz/sinusoide_enop-chap_slci.pdf}
            }
        }
    }  \\
    \midrule
    ...
    {\tikzset{external/export=false}       
        \raisebox{-.5\height}{%  
            \resizebox{\linewidth}{!}{%
                \includegraphics[width=0.8\textwidth]{figtikz/sinusoide_enqp-chap_slci.pdf}
            }
        }
    }\\
    \midrule
    ...
    {\tikzset{external/export=false}       
        \raisebox{-.5\height}{%  
            \resizebox{\linewidth}{!}{%
                \includegraphics[width=0.8\textwidth]{figtikz/sinusoide_enqp2-chap_slci.pdf}
            }
        }
    }\\
    \bottomrule
    \end{tabular}
    \caption{Différents types de déphasage d'un (rouge) signal sinusoïdal 
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.8\textwidth]{figtikz/fonction_qqc-causal-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.8\textwidth]{figtikz/fonction_qqc-causal2-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/fonction_triangle-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\[
    e(t)=tu(t)-2(t-1)u(t-1)+(t-2)u(t-2)
\]
\newpage
\input{re/newgeometry}
\captionsetup{width=0.9\linewidth,labelfont=bf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{Pierre-Simon-Laplace_2}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{Fourier}
...
\]
L'intégration de celle-ci est difficile à mettre en œuvre\footnote{
...
on préférera l'utilisation des tables de transformations de Laplace pour 
...
réaliser une décomposition en éléments simples de la réponse $S(p)$ pour 
...
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Retard en $p$ (Théorème de l'amortissement)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
dans le domaine temporelle d'un signal dont on connaît 
...
dans ce chapitre, lorsque nous introduirons la fonction de 
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/laplace_schema.pdf}
...
en œuvre, notamment dans le cas d'équation différentielle d'ordre élevé 
ou encore pour des systèmes composés de sous-systèmes.

La transformée de Laplace permet de mettre en œuvre une méthode plus simple et 
systématique  pour la la résolution de ces équations différentielles à 
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{OliverHeaviside.eps}
...
considérera dans un premier temps que les systèmes pour lesquels toutes les 
\textbf{conditions initiales sont nulles}, appelées également les conditions 
d'Heaviside
\newpage
\restoregeometry
\captionsetup{width=0.9\linewidth,labelfont=bf}
...
des équations différentielles est une méthode plus systématique qui 
s'affranchit de la forme particulière de l'équation différentielle 
à laquelle on a à faire. Nous verrons que la transformée de Laplace devient 
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/sol_eq_diff-chap_slci.pdf}}
    \caption{Représentation de la solution générale de l'équation 
             ...
             propriétés du signal (c.-à-d. conditions initiales, 
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.4\textwidth]{figtikz/sb_bloc_FT-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
et du dénominateur La forme canonique de la fonction de transfert 
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{WalterEvans.eps} 
...
\begin{figure}[!h]
    \center
    \includegraphics[width=0.8\textwidth]{figtikz/carte-chap_slci.pdf}
...
\small
%{\tikzset{external/export=false} 
\input{tex/exercices_chap_slci.tex}
%}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_corriges_chap_slci.tex}
\normalsize
\restoregeometry
\captionsetup{width=0.9\linewidth,labelfont=bf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
