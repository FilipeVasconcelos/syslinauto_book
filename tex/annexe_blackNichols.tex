...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{black_nichols_3_0.eps}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{black_nichols_5_0.eps}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{black_nichols_8_0.eps}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.45\textwidth]{bode_hbo.eps}
    \includegraphics[width=0.45\textwidth]{bode_hbf.eps}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.45\textwidth]{nyquist_hbo_m-cercles.eps}
    \includegraphics[width=0.45\textwidth]{nyquist_hbo_n-cercles.eps}
    \caption{Diagramme de Nyquist de la fonction de transfert en boucle ouverte,
    superposé (gauche) aux M-cercles (droite) aux N-cercles.}
\end{figure}
%-------------------------------------------------------------------------------
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{blackNichols_hbo-annexe_blackNichols-ext}
    \includegraphics[width=0.45\textwidth]{blackNichols_hbo.eps}
    \caption{Diagramme de Black du système en boucle ouverte 
             superposé à l'abaque de Black-Nichols.
             \label{fig-exemple1_BlackNichols}}
\end{figure}
%-------------------------------------------------------------------------------
Il est même tout à fait possible de suivre le gain et la phase du système en 
boucle fermée pour toutes les valeurs de la pulsation représentées.
%-------------------------------------------------------------------------------
%\begin{figure}[!h]
%    \centering
%    \includegraphics[width=0.45\textwidth]{black_nichols_14_1.eps}
%    \includegraphics[width=0.45\textwidth]{black_nichols_15_1.eps}
%\end{figure}
%-------------------------------------------------------------------------------
...
%\begin{figure}[!h]
%    \centering
%    \includegraphics[width=0.8\textwidth]{black_nichols_16_2.eps}
%\end{figure}
%-------------------------------------------------------------------------------
...
%\begin{figure}[!h]
%    \centering
%    \includegraphics[width=0.8\textwidth]{black_nichols_18_2.eps}
%\end{figure}
%-------------------------------------------------------------------------------
...
%\begin{figure}[!h]
%       \centering
%    \includegraphics[width=0.8\textwidth]{black_nichols_20_2.eps}
%\end{figure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
