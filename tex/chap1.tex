...
Celles-ci peuvent être des grandeurs temporelles ou \og fréquentielles\fg (i.e dans le domaine de Laplace). 
\begin{center}
...
\end{tikzpicture}    
\end{center}
Pour alléger la notation, nous allons omettre la variable $p$ des grandeurs 
