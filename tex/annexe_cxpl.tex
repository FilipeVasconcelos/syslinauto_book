...
\begin{center}
\tikzsetnextfilename{plan_complexe-annexeE-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis lines = center,
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{plan_complexe_2-annexeE-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis lines = center,
...
\begin{figure}[!ht]
    \centering
\tikzsetnextfilename{arctangente-annexeE-ext}
    \begin{tikzpicture}
        \begin{axis}[
...
\begin{figure}[!ht]
\centering
\tikzsetnextfilename{cercle_trigo-annexeE-ext}
\begin{tikzpicture}[scale=2.5,cap=round,>=latex]
    ...
    \draw (-1.5cm,0cm) node[above=1pt] {\scalebox{.6}{$(-1,0)$}}
     ...
     \draw[red]   (-0.5cm,-0.87cm) rectangle (0.5cm,0.87cm);
     \draw[green] (-0.71cm,-0.71cm) rectangle (0.71cm,0.71cm);
     \draw[blue]  (-0.87cm,-0.5cm) rectangle (0.866025cm,0.5cm);
     \node[above left,xshift=0.1em,red] at (0.5,0) 
    {\scalebox{0.6}{$\dfrac{1}{2}$}};
     \node[above left,xshift=0.2em,green] at (0.707106,0) 
    {\scalebox{0.6}{$\dfrac{\sqrt{2}}{2}$}};
     \node[above left,xshift=0.2em,blue] at (0.866025,0) 
    {\scalebox{0.6}{$\dfrac{\sqrt{3}}{2}$}};
\end{tikzpicture}
\caption{Quelques points particuliers du cercle 
         trigonométrique ou cercle unité.}
\end{figure}
\afterpage{\clearpage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
