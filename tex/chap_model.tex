...
5\% $t_{5\%}$ (temps au bout duquel la réponse indicielle atteint 95\% du signal 
final) est donné par :
$$
...
la pulsation propre du système. Cette pulsation est celle de l'oscillateur 
harmonique équivalent sans amortissement ($\xi=0$).
...
%\cdot\dfrac{1}{p} = \dfrac{\omega^2_0}{(p-\alpha)^2+\omega^2_d}\cdot\dfrac{1}{p}
%$$
$$
