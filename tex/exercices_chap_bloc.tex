...
En appliquant les lois de Kirchoff, on obtient les relations suivantes entre les 
...
\begin{align*}
    ...
    v_2(t)&=R_2i_3(t)
\end{align*}
En remplaçant celles-ci dans les relations de Kirchoff, on obtient les équations 
régissant ce modèle électrique:
\begin{align*}
