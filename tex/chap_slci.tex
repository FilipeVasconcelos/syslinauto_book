...
\paragraph{Exemples}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Pour un système d'ordre $n=2$, de classe 0 et $m=0$, 
...
\begin{marginfigure}
    ...
    \captionsetup{width=0.8\linewidth}
    \caption*{\index{Heaviside, Oliver}Oliver Heaviside, (1850-1925), physicien 
              britannique. Il développa le calcul opérationnel pour résoudre 
...
\begin{marginfigure}
    ...
    \captionsetup{width=0.8\linewidth}
    \caption*{Walter Richard Evans, (1920-1999),ingénieur, automaticien 
    américain. Il développa la méthode graphique, qui porte son nom,
    permettant d'étudier les pôles des systèmes asservis.}
\end{marginfigure}
%-------------------------------------------------------------------------------
