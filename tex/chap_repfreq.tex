...
\begin{marginfigure}[-20em]
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/repham_1-chap_repfreq.pdf}}
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/repham_2-chap_repfreq.pdf}}
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/repham_3-chap_repfreq.pdf}}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/sche_bode-chap_repfreq.pdf}
...
\begin{figure}[!b]
    \centering
    \resizebox{.45\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/sche_nyquist_3-chap_repfreq.pdf}}
    \resizebox{.45\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/sche_nyquist_4-chap_repfreq.pdf}}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/sche_black-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_gain_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_gain_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_integ_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_integ_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_deriv_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_deriv_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_retard_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_retard_2-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_1er_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_1er_2-chap_repfreq.pdf}
...
\begin{figure}[!b]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_1er_3-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_1er_4-chap_repfreq.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{figtikz/bode_1er_5-chap_repfreq.pdf}

\includegraphics[width=0.5\textwidth]{figtikz/bode_1er_6-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_1er_serie_2nd_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_1er_serie_2nd_2-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_2nd_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_2nd_2-chap_repfreq.pdf}
...
\begin{figure}[!t]
    ...
    \includegraphics[width=0.5\textwidth]{figtikz/bode_2nd_5-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/gain_resonance-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/bode_exemple_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/bode_exemple_2-chap_repfreq.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/nyquist_contour-chap_repfreq.pdf}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/nyquist_gainpur-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/nyquist_integ-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/nyquist_deriv-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/nyquist_retard-chap_repfreq.pdf}}
...
\begin{figure}[!hb]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/nyquist_1er-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/nyquist_2nd_1-chap_repfreq.pdf}

    \includegraphics[width=0.5\textwidth]{figtikz/nyquist_2nd_3-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/nyquist_effet_retard_1-chap_repfreq.pdf}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/black_integ-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/black_deriv-chap_repfreq.pdf}}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/black_1er-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/black_2nd-chap_repfreq.pdf}
    \includegraphics[width=0.5\textwidth]{figtikz/black_2nd_resonance-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/repham_transitoire_1er-chap_repfreq.pdf}
