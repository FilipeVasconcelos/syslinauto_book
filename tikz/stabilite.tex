    ...
    \node[anchor=south west] at (pt1) {
        ...
        [
           ...
           \addplot[signal,black!10!green]{1.2*sin(2.5*deg(x))*exp(-0.5*x)};
                \addplot[thick,dotted,color=black,domain=0:10, samples=501]
                {1.2*exp(-0.5*x)};
                \addplot[thick,dotted,color=black,domain=0:10, samples=501]
                {-1.2*exp(-0.5*x)};
                \end{axis}
            ...
            \node[anchor=south west] at (pt62) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black!50!white,domain=0:10,samples=501]
                    {sin(2.5*deg(x))};
                    \end{axis}
                \end{tikzpicture}
            };
            ...
            \node[anchor=south west] at (pt7) {
                ...
                \begin{axis}
                  ...
                  \addplot[very thick,color=blue,domain=0:10, samples=201]
                  {sin(2.5*deg(x))*exp(0.40*x)+1};
                  \addplot[thick,dotted,color=black,domain=0:10, samples=201]
                  {exp(0.4*x)+1};
                  \addplot[thick,dotted,color=black,domain=0:10, samples=201]
                  {-exp(0.4*x)+1};
                  \end{axis}
            ...
            \node[anchor=south west] at (pt8) {
                \begin{tikzpicture}
                    ...
                    \addplot[very thick,color=orange,domain=0:15,samples=201]
                    {1+exp(0.1*x)};
                    \end{axis}
                \end{tikzpicture}
            };
