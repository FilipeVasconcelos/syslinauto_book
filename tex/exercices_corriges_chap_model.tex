...
\begin{center}
    \includegraphics
    [width=0.7\textwidth]{reponse_2nd_ordre-exercices_corriges-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    \includegraphics
    [width=0.4\textwidth]{2nd_ordre-exercices_corriges-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.5\textwidth]{chute_libre-exercices_corriges-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    \includegraphics
    [width=0.4\textwidth]{sb_chute_libre-exercices_corriges-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.47\textwidth]{carte_poles-exercices_corriges-chap_model.pdf}
    \includegraphics
    [width=0.47\textwidth]{1er_ordre-exercices_corriges-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.8\textwidth]
    {depassement_amortissement-exercices_corriges-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.8\textwidth]
    {rapidite_tr_2ndordre-exercices_corriges-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.7\textwidth]{2nd-exercices_corriges-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
On cherche $x$ tel que $s(0.1)=75$, 75 étant la valeur du gain statique 
par $E_0$ à partir de \SI{0.1}{\second}.
De ce fait :
\[
