...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/reponse_indicielle_non_corrige-exercices_corriges-chap_correction.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{figtikz/reponse_indicielle_corrigee-exercices_corriges-chap_correction.pdf}
\caption{Réponse indicielle du système en boucle fermée non corrigé 
