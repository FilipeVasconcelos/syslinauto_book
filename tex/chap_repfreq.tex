...
\begin{marginfigure}[-20em]
    \centering
    \resizebox{\linewidth}{!}{
        \includegraphics[width=\textwidth]{repham_1-chap_repfreq.pdf}}
    \resizebox{\linewidth}{!}{
        \includegraphics[width=\textwidth]{repham_2-chap_repfreq.pdf}}
    \resizebox{\linewidth}{!}{
        \includegraphics[width=\textwidth]{repham_3-chap_repfreq.pdf}}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{sche_bode-chap_repfreq.pdf}
...
\begin{figure}[!b]
    ...
    \resizebox{.45\linewidth}{!}{
        \includegraphics[width=\textwidth]{sche_nyquist_3-chap_repfreq.pdf}}
    \resizebox{.45\linewidth}{!}{
        \includegraphics[width=\textwidth]{sche_nyquist_4-chap_repfreq.pdf}}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{sche_black-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{bode_gain_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{bode_gain_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\textwidth]{bode_integ_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{bode_integ_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\textwidth]{bode_deriv_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{bode_deriv_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\textwidth]{bode_retard_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{bode_retard_2-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.7\textwidth]{bode_1er_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{bode_1er_2-chap_repfreq.pdf}
    \caption{\textbf{Effet du gain $K$.} Diagramme de Bode d'un système 
             du premier ordre (\Cref{eq-1er_ftjw}) avec (noir) $K=0.1$ 
                                                        (bleu) $K=1$ et 
                                                        (rouge) $K=10$. 
             L'effet de $K$ est de décaler verticalement 
...
\begin{figure}[!b]
    \centering
    \includegraphics[width=0.7\textwidth]{bode_1er_3-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{bode_1er_4-chap_repfreq.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.7\textwidth]{bode_1er_5-chap_repfreq.pdf}

\includegraphics[width=0.7\textwidth]{bode_1er_6-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.7\textwidth]{bode_1er_serie_2nd_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{bode_1er_serie_2nd_2-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.7\textwidth]{bode_2nd_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{bode_2nd_2-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    %\includegraphics[width=0.5\textwidth]{bode_2nd_3-chap_repfreq.pdf}

    %\includegraphics[width=0.5\textwidth]{bode_2nd_4-chap_repfreq.pdf}
    \includegraphics[width=0.7\textwidth]{bode_2nd_5-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{gain_resonance-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{bode_exemple_1-chap_repfreq.pdf}

    \includegraphics[width=0.8\textwidth]{bode_exemple_2-chap_repfreq.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.8\textwidth]{nyquist_contour-chap_repfreq.pdf}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{nyquist_gainpur-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{nyquist_integ-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{nyquist_deriv-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{nyquist_retard-chap_repfreq.pdf}}
...
\begin{figure}[!hb]
    \centering
    \includegraphics[width=0.8\textwidth]{nyquist_1er-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.47\textwidth]{nyquist_2nd_1-chap_repfreq.pdf}
    \includegraphics[width=0.47\textwidth]{nyquist_2nd_3-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics
    [width=0.8\textwidth]{nyquist_effet_retard_1-chap_repfreq.pdf}
...
Le~\cref{tab-nyquistresume} synthétise les variations asymptotiques du
...
\begin{table}
    ...
    \hline
    $\dfrac{1}{(1-\tau^2_n\omega^2)+j2\xi\tau_n\omega}$ 
    & $1\rightarrow0$ 
    & $0\rightarrow-\pi$\\[1em]
    \hline
    $e^{-\jtw}$ & 1 & $0\rightarrow\infty$\\[1em]
    \hline
    $1+\jtw$ & $1\rightarrow\infty$ 
             & $0\rightarrow\dfrac{\pi}{2}$\\[1em]
    \hline
    $\dfrac{1}{1-\jtw}$ & $1\rightarrow0$
                        & $0\rightarrow\dfrac{\pi}{2}$\\[1em]
    \hline
    ...
    \hhline{===}
    \end{tabular}
    \caption{Variation du module et de l'argument du nombre 
             complexe $H(\jw)$ lorsque $\omega$ varie de 
             $0\rightarrow\infty$\label{tab-nyquistresume}}
\end{table}
%-------------------------------------------------------------------------------
\clearpage
\input{re/newgeometry}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{black_integ-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{black_deriv-chap_repfreq.pdf}}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{black_1er-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.45\textwidth]{black_2nd-chap_repfreq.pdf}
    \includegraphics[width=0.45\textwidth]{black_2nd_resonance-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics
    [width=0.9\textwidth]{repham_transitoire_1er-chap_repfreq.pdf}
