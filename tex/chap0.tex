...
\end{bequation}
valable que si $s(\infty)$ est définie
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Transformée d'une sinus}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\footnote{Dans le cas particulier
%de cette équation différentielle, il apparaitra que la résolution \og classique\fg soit plus
%facile à appliquer. La TL est cependant plus systèmatique et ne nécessite 
%que la connaissance d'algèbre on observera que la méthode classique est plus 
...
s(t)=1-2e^{-t}
\end{bequation}
On laisse au lecteur le soin de vérifier que cette fonction est solution de l'équation~\ref{eq-diff1},
et respecte les conditions initiales, notamment à partir de sa représentation graphique (\Cref{fig-solution}).
...
de transfert puisque $E(p)=1$. Autrement dit, la fonction de 
