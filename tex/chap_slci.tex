...
\addplot[signal,domain=0:30,black] {1};
\addplot[signal,domain=0:30,cyan] {6.25*(1-exp(-x/5))-1.25*(1-exp(-x))};
\addplot[signal,domain=0:30,green] {1.25*(1-exp(-x))};
\addplot[signal,domain=0:30,blue] {6.25*(1-exp(-x/5))};
...
\begin{center}
\tikzsetnextfilename{carte2-chap1-ext}
