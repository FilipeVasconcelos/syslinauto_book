...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{systeme-chap_slci.pdf}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{sb_bloc-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{principe_linearite-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.8\textwidth]{principe_superposition_1-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=0.5\textwidth]{principe_superposition_2-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{principe_invariance-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}[-8em]   
    \centering
    \includegraphics[width=\textwidth]{decharge_condensateur-chap_slci.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{causal-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Retardé}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.8\textwidth]{retarde-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{periodique-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.25\textwidth]{entree_echelon-chap_slci.pdf}
    \includegraphics[width=0.25\textwidth]{stable_echelon-chap_slci.pdf}
    \includegraphics[width=0.25\textwidth]{instable_echelon-chap_slci.pdf}

    \includegraphics[width=0.25\textwidth]{entree_harm-chap_slci.pdf}
    \includegraphics[width=0.25\textwidth]{stable_harm-chap_slci.pdf}
    \includegraphics[width=0.25\textwidth]{instable_harm-chap_slci.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{dirac-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{dirac_reel-chap_slci.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{echelon-chap_slci.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{rampe-chap_slci.pdf}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=0.8\textwidth]{sinusoide-chap_slci.pdf}}
...
\begin{marginfigure}
    ...
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{exp_dec-chap_slci.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{sinusoide_amortie-chap_slci.pdf}}
...
\begin{table}[!h]
    ...
    {\tikzset{external/export=false}       
        \raisebox{-.5\height}{%
        \resizebox{\linewidth}{!}{%
        \includegraphics[width=0.8\textwidth]{sinusoide_enp-chap_slci.pdf}}}
    }  \\
    \midrule
    $\Delta\phi=\pm\pi$         
    ...
    {\tikzset{external/export=false}       
        \raisebox{-.5\height}{%
        \resizebox{\linewidth}{!}{%
        \includegraphics[width=0.8\textwidth]{sinusoide_enop-chap_slci.pdf}
        }
        }
    }  \\
    \midrule
    ...
    {\tikzset{external/export=false}       
        \raisebox{-.5\height}{%  
            \resizebox{\linewidth}{!}{%
            \includegraphics[width=0.8\textwidth]{sinusoide_enqp-chap_slci.pdf}
            }
        }
    }\\
    \midrule
    ...
    {\tikzset{external/export=false}       
        \raisebox{-.5\height}{%  
            \resizebox{\linewidth}{!}{%
            \includegraphics[width=0.8\textwidth]{sinusoide_enqp2-chap_slci.pdf}
            }
        }
    }\\
    \bottomrule
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.9\textwidth]{fonction_qqc-causal-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.9\textwidth]{fonction_qqc-causal2-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{fonction_triangle-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{marginfigure}
    ...
    \caption*{\index{Fourier, Joseph}\textbf{Jean Baptiste Joseph Fourier}, 
              (1768-1830) mathématicien et physicien français. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Soit $s(t-\tau)u(t-\tau)$, un signal $s(t)$ causal présentant un retard $\tau$.
\[
...
%-------------------------------------------------------------------------------
\begin{bequation}[ams align]
    \laplace{s(t-\tau)u(t-\tau)}=e^{-p\tau}S(p)
\end{bequation}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{laplace_schema.pdf}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{
    \includegraphics[width=\textwidth]{sol_eq_diff-chap_slci.pdf}}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.4\textwidth]{sb_bloc_FT-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{figure}[!h]
    \center
    \includegraphics[width=0.8\textwidth]{carte-chap_slci.pdf}
