\begin{tikzpicture}
    ...
    \tikzstyle{recpos}=[white!90!col1,fill=white!90!col1]
    \begin{axis}
    ...
    \addplot[signalb,domain=-3:0] {0};                                
    \addplot[signalb,domain=0:10] {sin(3*deg(x))*exp(-0.5*x)+1};
    \draw[dotted,very thick,col1] (axis cs:0,0) -- (axis cs:0,1); 
    \node[black] at (axis cs:-1.5,2.0) {$s(t)=0$};
    \node[col1] at (axis cs:5.0,2.0) {$s(t)\ne0$};
    \end{axis}
\end{tikzpicture}
