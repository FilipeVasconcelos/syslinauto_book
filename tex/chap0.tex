...
nous représenterons par de la façon suivante :
\begin{center}
...
\end{tikzpicture}
\end{center}
où $e(t)$ et $s(t)$ sont respectivement es signaux d'entrée et de sortie 
dépendants du temps. 
...
\begin{itemize}
    ...
    Schématiquement, on exprime ce principe de la façon suivante:
    \begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{Un système est dit invariant si la sortie ne dépend pas explicitement du temps
autrement que par l'intermédiaire de l'entrée.}
Autrement dit, 
\begin{center}
