...
\[
    e_1(t)=tu(t)-2(t-1)u(t-1)+2(t-3)u(t-3)-(t-4)u(t-4)
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
chacun des termes.
\[
    E_1(p)=\dfrac{1}{p^2}-2\dfrac{e^{-p}}{p^2}
                       +2\dfrac{e^{-3p}}{p^2}
                       -\dfrac{e^{-4p}}{p^2}
\]
ou encore
...
\begin{figure}[!h]
    \centering
    \includegraphics
    [width=0.5\textwidth]{fonction_e2-exercices_corriges-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
\[
e_2(t)=
...
\[
    e_2(t)=t^2u(t)-4(t-1)u(t-1)+(t-2)^2u(t-2)
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$E_2(p)$ de $e_2(t)$ :
\[
    E_2(p)=\dfrac{2}{p^3}-4e^{-p}\dfrac{1}{p^2}+e^{-2p}\dfrac{2}{p^3}
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\exercice{Décomposition d'un signal et transformée de Laplace}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\[
    e_3(t)=(1-t)\left(u(t)-u(t-1)\right)=u(t)-tu(t)+(t-1)u(t-1)
\]
et
\[
    e_4(t)=t\left(u(t)-u(t-1)\right)=tu(t) - (t-1)u(t-1) - u(t-1)
\]
...
\[
    E_3(p)=\dfrac{1}{p}-\dfrac{1}{p^2}+\dfrac{e^{-p}}{p^2}
\]
et
\[
    E_4(p)=\dfrac{1}{p^2}-\dfrac{-e^{-p}}{p^2}-\dfrac{e^{-p}}{p}
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\[
    E(p)=E_3(p)+e^{-p} E_4(p)
        = \dfrac{1}{p}-\dfrac{1}{p^2}+\dfrac{e^{-p}}{p^2} +
          e^{-p} \left(\dfrac{1}{p^2}-\dfrac{e^{-p}}{p^2} -
          \dfrac{e^{-p}}{p}\right)
\]
\[
    E(p)=\dfrac{1}{p}\left(1-e^{-2p}\right)+
         \dfrac{1}{p^2}\left(1-2e^{-p}-e^{-2p}\right)
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    ...
    \includegraphics
    [width=0.5\textwidth]
    {fonction_porte_decomposition-exercices_corriges-chap_slci.pdf}
    \includegraphics
    [width=0.5\textwidth]
    {fonction_porte_decomposition2-exercices_corriges-chap_slci.pdf}
\end{figure}
%-------------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\exercice{Transformée de Laplace d'un signal périodique~\difficile}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\question{\textbf{Déterminer le motif $e_m(t)$ du signal $e(t)$}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Le motif $e_m(t)$ du signal périodique $e(t)$ est simplement le signal triangle:
\[
    e_m(t)=\begin{cases} 
        \dfrac{2}{\tau_0}t\quad 0<t<\dfrac{\tau_0}{2} \\
        -\dfrac{2}{\tau_0}\left(t-\tau_0\right)\quad\dfrac{\tau_0}{2}<t<\tau_0\\
        0\quad \text{sinon}
    \end{cases}
\]
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics
    [width=0.5\textwidth]{signal_periodique_motif-exercices-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\question{\textbf{Ecrire le signal périodique comme une somme infinie 
de tous les motifs retardés d'un temps $k\tau$ avec $k\in\mathbb{N}^*$}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Le signal périodique est une somme de signaux retardés $e_m(t-k\tau_0)$ tel que
\[
    e(t)=e_m(t)+e_m(t-\tau_0)+e_m(t-2\tau_0)+e_m(t-3\tau_0)\ldots
\]
\[
    e(t)=\sum_{k=0}^\infty e_m(t-k\tau_0)
\]
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics
    [width=0.5\textwidth]{signal_periodique_motif2-exercices-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\question{\textbf{Déterminer la transformée de Laplace du signal $E(p)$ 
en fonction de la transformée de Laplace du motif $E_m(p)$}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
En appliquant la propriété du retard en $t$ de la transformée de
Laplace, la transformée de Laplace $E(p)$ est simplement la somme 
des transformées des motifs retardés :
\[
    E(p)=E_m(p)(1+e^{-p\tau_0}+e^{-2p\tau_0}+e^{-3p\tau_0}+\ldots)
\]
\[
    E(p)=E_m(p)\sum_{k=0}^\infty e^{-pk\tau_0}
\]
En identifiant la série géométrique, on obtient la relation générale entre
la transformée de Laplace d'un signal périodique et la transformée de son motif:
\[
    E(p)=\dfrac{E_m(p)}{1-e^{-p\tau_0}}
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\question{\textbf{Déterminer alors la transformée de Laplace du motif $E_m(p)$}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\[
    e_m(t)=\dfrac{2}{\tau_0}t u(t)
           -\dfrac{4}{\tau_0}\left(t-\dfrac{\tau_0}{2}\right) 
            u\left(t-\frac{\tau_0}{2}\right) +
            \dfrac{2}{\tau_0}\left(t-\tau_0\right)u(t-\tau_0)
\]
La transformée de Laplace $E_m(p)$ devient :
\[
    E_m(p)=\dfrac{2}{\tau_0}\dfrac{1}{p^2}\left(
    1 - 2 e^{-p\frac{\tau_0}{2}} + e^{-p\tau_0}\right)
\]
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Dans cet exercice nous allons appliquer la méthode \og classique\fg pour la
...
\begin{center}
    ...
    {laplace_schema_decharge_condensateur-exercices_corriges-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{figure}[!h]
    ...
    \includegraphics
    [width=0.6\textwidth]
    {decharge_condensateur-exercices_corriges-chap_slci.pdf}
...
\]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\question{\textbf{Identifier la fonction de transfert $H(p)$ du système et 
...
(c.-à-d. $a\to0$).    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\question{\textbf{Identifier la solution algébrique $Z(p)$ pour une cette 
sollicitation}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    \includegraphics
    [width=0.6\textwidth]
    {masse_ressort_solution-exercices_corriges-chap_slci.pdf}
\end{center}
%-------------------------------------------------------------------------------
%\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
