...
solution de l'équation différentielle du système. En général, 0 est toujours
...
mouvement d'une bille à la surface d'une fonction d’énergie potentielle à une 
dimension. 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{stable_1-chap_stab.pdf}
...
%-------------------------------------------------------------------------------
\begin{itemize}
    \item (\Cref{fig-stab} (a)) Dans le cas d'un équilibre stable : 
        la bille va naturellement retrouver (avec ou sans oscillations) 
        sa position d'équilibre. 
    \item (\Cref{fig-stab} (b)) Dans le cas d'un équilibre instable :
...
Dans le cas des \glspl{slci}, il est possible d'étudier la stabilité du système 
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.9\textwidth]{stabilite-bibo-chap_stab.pdf}
...
\begin{center}
    \includegraphics
    [width=0.9\textwidth]{instabilite_pompage-non_boucle-chap_stab.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    \includegraphics
    [width=\textwidth]{instabilite_pompage-chap_stab.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
Pour la seconde demi-période, la sollicitation est 
négative $e_2=-E_0$ et la sortie est maintenant donnée par 
$s_2=KE_0$. De la même manière pour la troisième demi-période, 
on obtient $s_3=K\epsilon_2=K(e_2-s_2)=-E_0(K+K^2)$. 
...
observer la condition sur ses pôles pour que le système soit stable selon les 
...
négatives pour que les exponentielles, présentes dans la réponse temporelle, 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=1.3\textwidth]{stabilite.pdf}
...
La~\cref{fig-stab_imp_all} présente schématiquement les réponses 
...
%-------------------------------------------------------------------------------
%\begin{center}
%    \includegraphics[width=0.5\textwidth]{asser-chap_stab.pdf}
%\end{center}
%-------------------------------------------------------------------------------
%\[
...
construction graphique des lieux d'Evans (c.f~\Cref{annexe-evans})
%-------------------------------------------------------------------------------
\newpage
...
directement sur la fonction de transfert $H_{BF}(p)$ en boucle fermée 
du système asservi. 
\[
    H(p)=\dfrac{N(p)}{D(p)}
\]
...
construire le \textbf{tableau de Routh} à partir des coefficients de l'équation 
...
éléments des deux premières lignes.
\[
\begin{matrix}
    p^n    \\
    p^{n-1}\\
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{routh_exemple-chap_stab.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Critère de stabilité du revers\index{Critère de stabilité! du revers}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
le système en boucle ouverte. Cependant, \textbf{le but est toujours de vérifier
indirectement la condition fondamentale de stabilité des systèmes asservis}
(c.-à-d. la nature des pôles de la fonction de transfert en boucle fermée).

Pour cela considérons la boucle de contre réaction unitaire 
pour l'asservissement d'un système de fonction de transfert $H(p)$, telle que :
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{sb_revers-chap_stab.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\textbf{point critique}\index{Point critique} de $H_{BO}(p)$.

Pour montrer quelques propriétés de $1+H_{BO}(p)$, nous allons réécrire
...
\begin{bequation}[ams align]
    ...
    1+H_{BO}(p)&=\dfrac{D_{BO}(p)+N_{BO}(p)}{D_{BO}(p)}
\end{bequation}
%-------------------------------------------------------------------------------
on a alors pour la fonction de transfert en boucle fermée, 
%-------------------------------------------------------------------------------
\begin{bequation}[ams align]
H_{BF}(p)=\dfrac{N_{BO}(p)}{D_{BO}(p)+N_{BO}(p)}
\end{bequation}
%-------------------------------------------------------------------------------

Nous remarquons, à partir de cette dernière relation,
...
%\]
en régime permanent la sortie est de la forme (c.f~\Cref{chap-repfreq}) :
\[
...
\begin{criteria}{Critère de stabilité du revers}
    Un système est stable en boucle fermée si lorsque le 
...
réponse harmonique du système en boucle ouverte (c.f~\Cref{chap-repfreq}).
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
La~\cref{fig-nyquist_revers} présente 
...
est supérieur à 1. Nous appellerons critique le système dont le lieu de Nyquist 
passe par le point critique de coordonnées $(-1,0)$.
%-------------------------------------------------------------------------------
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{critere_revers_nyquist-chap_stab.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{critere_revers_black-chap_stab.pdf}
...
\begin{figure}[!h]
\centering
    \includegraphics[width=\textwidth]{critere_revers_bode-chap_stab.pdf}
...
En général, des valeurs pour $M_{\phi}$ de 45 à 60\degreeSI et
pour $M_G$ de 6 à 15~\si{\dB} sont considérées comme satisfaisantes.

Il est possible de déterminer ces marges de stabilité par le calcul, mais 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{marge_stabilite_nyquist-chap_stab.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Marges de stabilité à partir du diagramme de Bode}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{marge_stabilite_bode-chap_stab.pdf}
    \caption{Représentation schématique des marges de stabilité du lieu de 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.6\textwidth]{marge_stabilite_black-chap_stab.pdf}
    \caption{Représentation schématique des marges de stabilité du lieu de 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{nyquist_cauchy-chap_stab.pdf}
...
En prenant des exemples simples (c.f \Cref{annexe-cauchy}\footnote{Cette 
...
\end{btheorem}
%-------------------------------------------------------------------------------
On se rapportera à nouveau à l'\Cref{annexe-cauchy} pour une démonstration 
...
Dans l'exemple de la~\cref{fig-contour_cauchy}, la fonction analytique $F(p)$ 
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.7\textwidth]{nyquist_ntours_1-chap_stab.pdf}
    \includegraphics[width=0.7\textwidth]{nyquist_ntours_5-chap_stab.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.7\textwidth]{nyquist_contour-chap_stab.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.7\textwidth]{bromwich_contour1-chap_stab.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.7\textwidth]{bromwich_contour2-chap_stab.pdf}
    \caption{Contours de Bromwich où 0, $p_1$ et $p_2$ sont des pôles
             ou zéros de $H_{BO}$.\label{fig-contour_Bromwich_2}} 
\end{marginfigure}
%-------------------------------------------------------------------------------
\textbf{De la même manière que précédemment, les images d'une fonction de 
...
\captionsetup{width=0.9\linewidth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Exemple d'image par le contour de Nyquist}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    \centering
    \includegraphics
    [width=0.4\textwidth]{nyquist_contour_image_exemple1-chap_stab.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics
    [width=0.4\textwidth]{bromwich_contour_image_exemple1-chap_stab.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\'Enoncé et application du critère de Nyquist}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Le critère de Nyquist consiste à relier le principe de l'argument de Cauchy au 
second critère de stabilité des systèmes asservis\label{critere2}.
Nous rappelons en effet qu'un système est stable en boucle fermée si la i
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{chap_stab_h1.eps}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{chap_stab_h2.eps}
...
Nous laissons au lecteur la vérification par application
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_chap_stab.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_corriges_chap_stab.tex}
\normalsize
\restoregeometry
\captionsetup{width=0.9\linewidth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
