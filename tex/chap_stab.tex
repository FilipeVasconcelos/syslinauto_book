...
Rappel sur les réponses temporelles du premier ordre et du second ordre ...
\acpl
...
\begin{criteria}{Condition de stabilité d'un système asservi (1)}
    \textbf{Un système asservi est stable si sa fonction de transfert en boucle 
            fermée ne possède aucun pôles à partie réelle positive.}
\end{criteria}
...
Le critère de Routh\footnote{\index{Routh, Edward}Edward John Routh (1831-1907), 
mathématicien anglais.} est dit algébrique car il s'établit dirctement sur la 
