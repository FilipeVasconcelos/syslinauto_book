...
\input{tikz/depassement_amortissement-exercices_corriges-chap_model.tex}
\end{center}
%-------------------------------------------------------------------------------
...
\input{tikz/rapidite_tr_2ndordre-exercices_corriges-chap_model.tex}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    ...
    \input{tikz/2nd-exercices_corriges-chap_model.tex}
\end{center}
%-------------------------------------------------------------------------------
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
