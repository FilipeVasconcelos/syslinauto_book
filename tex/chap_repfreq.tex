...
\begin{figure}[!h]
    ...
    \input{tikz/repham_1-chap_repfreq.tex}
    \tikzsetnextfilename{repham_2-chap_repfreq-ext}
    \input{tikz/repham_2-chap_repfreq.tex}
    \tikzsetnextfilename{repham_3-chap_repfreq-ext}
    \input{tikz/repham_3-chap_repfreq.tex}
...
\begin{marginfigure}
    ...
    \caption*{\index{Nichols, Nathaniel} Nathaniel B. Nichols, (1914–1997)
              ingénieur américain.}
\end{marginfigure}
%-------------------------------------------------------------------------------
...
\begin{marginfigure}
    ...
    \captionsetup{width=0.8\linewidth}
    \caption*{\index{Bode, Hendrik} Hendrik Wade Bode
...
\begin{marginfigure}
    ...
    \captionsetup{width=0.8\linewidth}
    \caption*{\index{Nyquist, Harry} Harry Nyquist (1889-1976), électronicien et
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_gainpur-chap_repfreq.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_integ-chap_repfreq.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_deriv-chap_repfreq.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_retard-chap_repfreq.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_2nd_2-chap_repfreq.tex}
