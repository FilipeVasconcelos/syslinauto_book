...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{figtikz/fonction_e1-exercices-chap_slci.pdf}
\end{marginfigure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{figtikz/fonction_e2-exercices-chap_slci.pdf}
\end{marginfigure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}
    ...
    \includegraphics[width=\textwidth]{figtikz/fonction_e3-exercices-chap_slci.pdf}
\end{marginfigure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}
    \centering
    \tikzsetnextfilename{fonction_e4-exercices-chap_slci-ext}
    \includegraphics[width=\textwidth]{figtikz/fonction_e4-exercices-chap_slci.pdf}
\end{marginfigure}
%-------------------------------------------------------------------------------
...
\begin{marginfigure}
    ...
    \includegraphics[width=\textwidth]{figtikz/fonction_porte-exercices-chap_slci.pdf}
\end{marginfigure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}
    ...
    \includegraphics[width=\textwidth]{figtikz/carte_exo-exercices-chap_slci.pdf}
\end{marginfigure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
