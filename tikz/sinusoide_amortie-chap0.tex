    \begin{tikzpicture}
        ...
        xticklabels={},
            ...
            \addplot [very thick,color=blue,domain=-2:0, samples=11]{0};
            \addplot [very thick,color=blue,domain=0:4*pi, samples=501]{exp(-0.2*x)*sin(3.5*deg(x))};
            \addplot [dashed,very thick,color=blue,domain=0:4*pi, samples=501]{exp(-0.2*x)};
            \addplot [dashed,very thick,color=blue,domain=0:4*pi, samples=501]{-exp(-0.2*x)};
            %\addplot [thick,color=red,domain=0:4*pi, samples=501]{exp(-0.2*x)*sin(deg(4*x-pi*0.5))};
