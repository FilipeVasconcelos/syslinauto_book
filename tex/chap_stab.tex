...
Nous remarquons alors, à partir de cette dernière relation,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Nous allons établir un critère de stabilité des systèmes asservis, dit du 
revers, que nous pourrons appliquer sur la réponse harmonique de la~\gls{ftbo} 
...
cas où $p=0$ est pôle de la fonction de transfert. Celui-ci est composé de 4 
portions:
%-------------------------------------------------------------------------------
%\begin{marginfigure}
%    \centering
...
%    \caption{Contours de Bromwich où 0 est un pôle ou zéro de $H_{BO}$
%             \label{fig-contour_Bromwich_1}} 
%\end{marginfigure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{marginfigure}
