...
\begin{center}
%{\tikzset{external/export=false}       
\tikzsetnextfilename{pole_dominant-chap0_ext}
\begin{tikzpicture}
\begin{axis}[%
...
\addplot[thick,color=cyan,domain=0:30,samples=101]{6.25*(1-exp(-x/5))-1.25*(1-exp(-x))};
...
\begin{center}
%{\tikzset{external/export=false}       
\tikzsetnextfilename{carte2-chap0_ext}
