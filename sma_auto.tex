...
\begin{picture}(0,0)
\put(50,-130){\includegraphics[width=3cm]{fig/ESME_LOGO_SEUL_NOIR_2021.eps}}
\end{picture}
\vfill
\centering
{\tikzset{external/export=false}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\graphicspath{{./fig/}{./fig/people}{./fig/chap_correction}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ------------------------------------------------------------------------------
...
%\includeonly{tex/chap_slci,tex/chap_bloc}            % Schémas fonctionnels-blocs
%\includeonly{tex/chap_model_mir_1,tex/chap_model_mir_2}           % Modèles Usuels    
\includeonly{tex/annexe_blackNichols,tex/chap_model}           % Modèles Usuels    
%\includeonly{tex/chap_repfreq}         % Réponse harmonique
%\includeonly{tex/chap_repfreq_mir}         % Réponse harmonique
...
%\includeonly{tex/chap_model,tex/annexe_equa_diff}     % Eq. diff. à coefficient constant
...
%    \include{tex/chap_model_mir_1}    %3bis Modèles de SLCI pour MIR
%    \include{tex/chap_model_mir_2}    %3ter Modèles de SLCI pour MIR
\include{tex/chap_repfreq}             %4 Réponse Harmonique
%\include{tex/chap_repfreq_mir}        %4 Réponse Harmonique
