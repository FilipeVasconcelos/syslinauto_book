...
\begin{tikzpicture}
    ...
    \draw[dvtb] (1.05,-1.65) rectangle node[blue,above,yshift=4em] 
...
\draw[dvtb]  (-0.8,-4) rectangle node[blue,xshift=-3.2em,yshift=7em] 
             {\textbf{Chaîne d'information}}(6.45,2.5);
\draw[dvtr]  (6.7,-4)  rectangle node[red,xshift=-5.9em,yshift=7em]  
