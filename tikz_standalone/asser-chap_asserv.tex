...
\draw[dvtb]  (-0.8,-4) rectangle node[col1,xshift=-4.4em,yshift=8.5em] 
             {\textbf{Chaîne d'information}}(6.2,2.8);
\draw[dvtr]  (6.3,-4)  rectangle node[col4,xshift=-6.8em,yshift=8.5em]  
             {\textbf{Chaîne d'énergie}    }(14.8,2.8);
\draw[dvtgf] (4,1)     -- node[col3,above,xshift=7.4em] {Chaîne direct}    (14,1) ;
\draw[dvtgf] (14,-3.7) -- node[col3,above,xshift=7.4em] {Chaîne de retour} (4,-3.7) ;
\end{tikzpicture}
