...
\begin{marginfigure}
    ...
    \includegraphics[width=0.5\textwidth]{carte_1er-chap_model.pdf}
    }
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.47\textwidth]{1er_imp1-chap_model.pdf}
    \hfill
    \includegraphics[width=0.47\textwidth]{1er_imp2-chap_model.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.47\textwidth]{1er_ind1-chap_model.pdf}
    \hfill
    \includegraphics[width=0.47\textwidth]{1er_ind2-chap_model.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.47\textwidth]{1er_ramp1-chap_model.pdf}
\hfill
\includegraphics[width=0.47\textwidth]{1er_ramp2-chap_model.pdf}
...
\begin{table}[!b]
    ...
    {\tikzset{external/export=false}
     \raisebox{-.5\height}{
     \includegraphics[width=0.3\textwidth]{poles_reels.pdf}}}\\
    \midrule
        Régime apériodique critique \[\xi=1\]                              & 
        Un pôle double réel\[p_1=p_2=-\omega_0\]                           & 
    {\tikzset{external/export=false}
     \raisebox{-.5\height}{
     \includegraphics[width=0.3\textwidth]{poles_double.pdf}}}\\
    \midrule
    ...
    {\tikzset{external/export=false}
     \raisebox{-.5\height}{
     \includegraphics[width=0.3\textwidth]{poles_complexes.pdf}}}\\
    \bottomrule
    \end{tabular}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{2nd_sb_imp-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
où $K_1K_2=K$.
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{2nd_pp_imp-chap_model.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{2nd_pp-chap_model.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{2nd_depassement_1-chap_model.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{depassement_amortissement.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{2nd_t5pc-chap_model.pdf}
...
\begin{figure}[!b]
\centering
    \includegraphics[width=0.8\textwidth]{rapidite_tr_2ndordre-chap_model.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{2nd_ramp-chap_model.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics
    [width=0.8\textwidth]{comportement_ziegler_nichols-chap_model.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{comportement_strecj-chap_model.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{comportement_broida-chap_model.pdf}
    \caption{\label{comportement_broida}}
\end{figure}
%-------------------------------------------------------------------------------
\acplhp 
c.f 
\url{http://w3.cran.univ-lorraine.fr/perso/hugues.garnier/
