...
\begin{tikzpicture}
	...
	\addplot[very thick,blue,domain=0:10, samples=201]{sin(3*deg(x))*exp(-x)+1};
...
\begin{tikzpicture}
    ...
    \addplot [very thick,blue,domain=-2:0, samples=101]{0};
    \addplot [very thick,blue,domain=0:10, samples=201]{0.5*x};
	\draw[dotted,very thick,blue] (axis cs:0,0) -- (axis cs:0,1);
	\end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}%
	...
	\addplot[very thick,color=red,domain=-2:0, samples=101]{0};
	\addplot[very thick,domain=0:10, samples=101]	{0.8*sin(3*deg(x))*exp(0.2*x)+1};
