...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{sb_ex1-exercices-chap_stab.pdf}
\end{center}
%-------------------------------------------------------------------------------
avec :
\[
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Le système $H(p)$ est asservi par retour unitaire à l'aide d'un gain $K$ 
(c.f schéma bloc) avec :
\[
...
de stabilité asymptotique du système ainsi asservi : on précisera, dans 
l'affirmative, les conditions sur $K$, ainsi que les marges de stabilité.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
