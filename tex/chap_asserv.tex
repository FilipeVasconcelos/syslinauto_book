...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sb_bloc0-chap_asserv.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
    \begin{center}
        \includegraphics[width=0.5\textwidth]{figtikz/sb_bloc2-chap_asserv.pdf}
    \end{center}
%-------------------------------------------------------------------------------
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/reg_2-chap_asserv.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/pert_2-chap_asserv.pdf}
    \caption{Schéma fonctionnel de l'asservissement d'un système 
...
%-------------------------------------------------------------------------------
\begin{center}
    \resizebox{\linewidth}{!}{\includegraphics[width=0.5\textwidth]{figtikz/asser-chap_asserv.pdf}}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/asser_1er-chap_asserv.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/asser_2nd-chap_asserv.pdf}
\end{center}
%-------------------------------------------------------------------------------
