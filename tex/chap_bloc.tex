...
\begin{center}
\tikzsetnextfilename{sb_fleche-chap2-ext}
\input{tikz/sb_fleche-chap2.tex}
\end{center}
...
\begin{center}
\tikzsetnextfilename{sb_bloc-chap2-ext}
\input{tikz/sb_bloc-chap2.tex}
\end{center}
...
\begin{center}
\tikzsetnextfilename{sb_comp-chap2-ext}
\input{tikz/sb_comp-chap2.tex}
\end{center}
...
\begin{center}
\tikzsetnextfilename{sb_somm-chap2-ext}
\input{tikz/sb_somm-chap2.tex}
\end{center}
...
\begin{center}
\tikzsetnextfilename{sb_point-chap2-ext}
\input{tikz/sb_point-chap2.tex}
\end{center}
...
\begin{center}
\tikzsetnextfilename{sb_reduc_serie_1-chap2-ext}
\input{tikz/sb_reduc_serie_1-chap2.tex}
\end{center}

\begin{center}
\tikzsetnextfilename{sb_reduc_serie_2-chap2-ext}
\input{tikz/sb_reduc_serie_2-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{sb_reduc_para_1-chap2-ext}
    \input{tikz/sb_reduc_para_1-chap2.tex}
\end{center}

\begin{center}
    \tikzsetnextfilename{sb_reduc_para_2-chap2-ext}
    \input{tikz/sb_reduc_para_2-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{boucle-chap2-ext}
    \input{tikz/boucle-chap2.tex}
\end{center}
...
simplifié suivant :
\begin{center}
    \tikzsetnextfilename{boucle_eq-chap2-ext}
    \input{tikz/boucle_eq-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{boucle_uni-chap2-ext}
    \input{tikz/boucle_uni-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{dep_comp1-chap2-ext}
    \input{tikz/dep_comp1-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{dep_comp2-chap2-ext}
    \input{tikz/dep_comp2-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{dep_comp3-chap2-ext}
    \input{tikz/dep_comp3-chap2.tex}
\end{center}
...
Considérons le schéma-bloc suivant :
\begin{center}
    \tikzsetnextfilename{dep_jonc1-chap2-ext}
    \input{tikz/dep_jonc1-chap2.tex}
\end{center}
Il est aisé de déplacer le bloc $K$ devant le point de prélèvement:  
\begin{center}
    \tikzsetnextfilename{dep_jonc2-chap2-ext}
    \input{tikz/dep_jonc2-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{dep_jonc3-chap2-ext}
    \input{tikz/dep_jonc3-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{reduc_mult1-chap2-ext}
    \input{tikz/reduc_mult1-chap2.tex}
\end{center}

Dans un premier temps, on considère l'entrée $P$ nulle, le schéma-bloc devient :
\begin{center}
    \tikzsetnextfilename{reduc_mult2-chap2-ext}
    \input{tikz/reduc_mult2-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{reduc_mult3-chap2-ext}
    \input{tikz/reduc_mult3-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{exemple_1-chap2-ext}
    \input{tikz/exemple_1-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{exemple_2-chap2-ext}
    \input{tikz/exemple_2-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{exemple_3-chap2-ext}
    \input{tikz/exemple_3-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{exemple_4-chap2-ext}
    \input{tikz/exemple_4-chap2.tex}
\end{center}

\`A nouveau il est possible d'identifier une boucle de contre-réaction $B_2$ :

\begin{center}
    \tikzsetnextfilename{exemple_5-chap2-ext}
    \input{tikz/exemple_5-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{exemple_6-chap2-ext}
    \input{tikz/exemple_6-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{exemple_7-chap2-ext}
    \input{tikz/exemple_7-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{exemple_8-chap2-ext}
    \input{tikz/exemple_8-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{exemple_9-chap2-ext}
    \input{tikz/exemple_9-chap2.tex}
\end{center}

La réduction de la boucle de contre réaction interne nous donne :

\begin{center}
    \tikzsetnextfilename{exemple_10-chap2-ext}
    \input{tikz/exemple_10-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_1-chap2-ext}
    \input{tikz/gf_1-chap2.tex}
$$
S=HE
$$
\end{center}
...
\begin{figure}[!h]
\begin{center}
    \tikzsetnextfilename{gf_source-chap2-ext}
    \input{tikz/gf_source-chap2.tex}
\end{center}
...
vers ce noeud.
\begin{center}
    \tikzsetnextfilename{gf_add-chap2-ext}
    \input{tikz/gf_add-chap2.tex}
\end{center}
$$
S=H_1E_1+H_2E_2
$$
...
\begin{center}
    \tikzsetnextfilename{sb_gf-chap2-ext}
    \input{tikz/sb_gf-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_distrib-chap2-ext}
    \input{tikz/gf_distrib-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_branche_serie-chap2-ext}
    \input{tikz/gf_branche_serie-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_branche_para-chap2-ext}
    \input{tikz/gf_branche_para-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_absorption-chap2-ext}
    \input{tikz/gf_absorption-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_boucle1-chap2-ext}
    \input{tikz/gf_boucle1-chap2.tex}
\end{center}

La variable $M$ du graphe de fluence peut être réduit, ce qui donne :

\begin{center}
    \tikzsetnextfilename{gf_boucle2-chap2-ext}
    \input{tikz/gf_boucle2-chap2.tex}
\end{center}

Il est possible d'éliminer le noeud porté par la variable $\epsilon$:

\begin{center}
    \tikzsetnextfilename{gf_boucle3-chap2-ext}
    \input{tikz/gf_boucle3-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_boucle4-chap2-ext}
    \input{tikz/gf_boucle4-chap2.tex}
\end{center}
Comme nous l'avons déjà discuté, dans le cas d'une boucle 
de contre-réaction unitaire, la branche de retour est égale à 1
\begin{center}
    \tikzsetnextfilename{gf_boucle5-chap2-ext}
    \input{tikz/gf_boucle5-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_boucle6-chap2-ext}
    \input{tikz/gf_boucle6-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_boucle7-chap2-ext}
    \input{tikz/gf_boucle7-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_mason1-chap2-ext}
    \input{tikz/gf_mason1-chap2.tex}
\end{center}
...
\begin{center}
    \tikzsetnextfilename{gf_mason2-chap2-ext}
    \input{tikz/gf_mason2-chap2.tex}
\end{center}
