...
\]
Dans la représentation géométrique le conjugué $\bar{z}$ est le symétrique 
de $z$ par rapport à l'axe des réels (\Cref{fig-plan_complexe}).
%-------------------------------------------------------------------------------
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/plan_complexe-annexe_cplx.pdf}
...
|z|=\sqrt{x^2+y^2},
\]
où $x=\Re{z}$ et $y=\Im{z}$ comme définis précédemment
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/plan_complexe_2-annexe_cplx.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/arctangente-annexe_cplx.pdf}
...
Une autre conséquence est que les fonctions trigonométriques peuvent 
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/cercle_trigo-annexe_cplx.pdf}
