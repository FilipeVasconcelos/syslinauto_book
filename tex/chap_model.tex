...
L'analyse dimensionnelle de cette équation différentielle, nous permet 
...
\begin{marginfigure}
    ...
    \includegraphics[width=0.5\textwidth]{figtikz/carte_1er-chap_model.pdf}
    }
...
Nous considérons une excitation impulsionnelle de la forme :
\[
e(t)=E_0\delta(t),
\]
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/1er_imp1-chap_model.pdf}
    \hfill
    \includegraphics[width=0.47\textwidth]{figtikz/1er_imp2-chap_model.pdf}
    ...
    \caption{Réponse impulsionnelle d'un système du premier ordre avec : 
             ...
             du gain $K$ pour $\tau=1$ (\Cref{eq-1er_imp}). (Tableau) 
...
s'(0)=-\dfrac{KE_0}{\tau^2}
\]      
La pente à l'origine est négative et inversement proportionnelle 
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/1er_ind1-chap_model.pdf}
    \hfill
    \includegraphics[width=0.47\textwidth]{figtikz/1er_ind2-chap_model.pdf}
...
s'(0)=\dfrac{KE_0}{\tau}
\]
La pente à l'origine est positive et inversement proportionnelle 
...
\begin{figure}
\centering
\includegraphics[width=0.47\textwidth]{figtikz/1er_ramp1-chap_model.pdf}
\hfill
\includegraphics[width=0.47\textwidth]{figtikz/1er_ramp2-chap_model.pdf}
...
Nous considérons maintenant une excitation rampe de la forme:
\[
...
\begin{table}[!b]
    ...
    {\tikzset{external/export=false}
     \raisebox{-.5\height}{\includegraphics[width=0.3\textwidth]{figtikz/poles_reels.pdf}}}                  \\
    \midrule
        Régime apériodique critique \[\xi=1\]                              & 
        Un pôle double réel\[p_1=p_2=-\omega_0\]                           & 
    {\tikzset{external/export=false}
     \raisebox{-.5\height}{\includegraphics[width=0.3\textwidth]{figtikz/poles_double.pdf}}}                 \\
    \midrule
    ...
    {\tikzset{external/export=false}
     \raisebox{-.5\height}{\includegraphics[width=0.3\textwidth]{figtikz/poles_complexes.pdf}}}              \\
    \bottomrule
    \end{tabular}
...
de transfert de la façon suivante en utilisant les pôles appropriés:
\[
...
et rampe) des systèmes du second ordre. On trouvera les représentations 
...
différents régimes du système du second ordre. Nous rappelons que l'étude 
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/2nd_sb_imp-chap_model.pdf}
\end{center}
%-------------------------------------------------------------------------------
où $K_1K_2=K$.
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/2nd_pp_imp-chap_model.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/2nd_pp-chap_model.pdf}
...
on observe que les dépassements successifs sont de moins en moins important. 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/2nd_depassement_1-chap_model.pdf}
...
\end{figure}
%-------------------------------------------------------------------------------
Pour cela il suffit de déterminer le temps pour lequel la dérivée 
...
%-------------------------------------------------------------------------------
\begin{bequation}[ams align]
    D=e^{-\dfrac{\xi\pi}{\sqrt{1-\xi^2}}}\label{eq-depassement}
\end{bequation}
%-------------------------------------------------------------------------------
...
en automatique. Ils permettent de s'affranchir de nombreux calculs 
...
sous MATLAB (\Cref{annexe-matlab}). 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/2nd_t5pc-chap_model.pdf}
...
\begin{figure}[!b]
\centering
    \includegraphics[width=0.8\textwidth]{figtikz/rapidite_tr_2ndordre-chap_model.pdf}
...
\]
où, rappelons que $\alpha=\xi\omega_0$ et $\omega_d=\omega_0\sqrt{1-\xi^2}$.
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/2nd_ramp-chap_model.pdf}
...
leurs sollicitations, elles sont simplement retardées de $\tau$.
%\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Nous allons ici généraliser l'approche pour l'étude de systèmes d'ordre 
supérieur à deux.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\]
La réponse temporelle est donc la somme des réponses temporelles de trois 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Modèle de Ziegler-Nichols}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%-------------------------------------------------------------------------------
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/comportement_ziegler_nichols-chap_model.pdf}
    \caption{\label{comportement_ziegler_nichols}}
\end{figure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/comportement_strecj-chap_model.pdf}
    \caption{\label{comportement_strecj}}
\end{figure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Modèle de Broïda}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Le modèle de Broïda permet de déterminer les paramètres de la fonction de
transfert en utilisant une méthode graphique ne faisant pas intervenir le
point d'inflexion.
%-------------------------------------------------------------------------------
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/comportement_broida-chap_model.pdf}
    \caption{\label{comportement_broida}}
\end{figure}
%-------------------------------------------------------------------------------
\acplhp 
c.f \url{http://w3.cran.univ-lorraine.fr/perso/hugues.garnier/Enseignement/Auto/C-Auto-Analyse.pdf}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_chap_model.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_corriges_chap_model.tex}
\normalsize
\restoregeometry
\captionsetup{width=0.9\linewidth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
