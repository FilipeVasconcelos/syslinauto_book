...
\begin{figure}[!h]
    ...
    \node[anchor=south west] at (pt1) 
    {
        ...
        \addplot[signaln6g,domain=0:6] {1.2*sin(4.5*deg(x))*exp(-0.7*x)};
    ...
    \node[anchor=south west] at (pt2) 
    {
        ...
        \addplot[signaln1g,domain=0:6] {1.2*sin(2.5*deg(x))*exp(-0.5*x)};
	...
	\addplot [signaln3r,domain=0:6]  {2*exp(-0.75*x)};
	\end{axis}
	\end{tikzpicture}
    };
    % pt4
	...
	[   xmin=-0.5,xmax=8,
        ...
        \addplot[signaln1g,domain=0:8]  {sin(2.5*deg(x))*exp(0.40*x)+1};
    ...
    \node[anchor=south west] at (pt62) 
    {
        ...
        \addplot[signaln5w,domain=0:6.5] {sin(2.5*deg(x))};
        \end{axis}
        \end{tikzpicture}
	};
    % pt7
	...
	[   xmin=-0.5,xmax=15,
        ...
        \addplot[signalo,domain=0:15] {1+exp(0.1*x)};
        \end{axis}
        \end{tikzpicture}
    };
    \end{tikzpicture}
