...
Enfin nous présenterons, la représentation des équations différentielles
...
%-------------------------------------------------------------------------------
\begin{center}
\includegraphics[width=0.5\textwidth]{figtikz/sb_fleche-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
\includegraphics[width=0.5\textwidth]{figtikz/sb_bloc-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
\includegraphics[width=0.5\textwidth]{figtikz/sb_comp-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
\includegraphics[width=0.5\textwidth]{figtikz/sb_somm-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
\includegraphics[width=0.5\textwidth]{figtikz/sb_point-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
\includegraphics[width=0.5\textwidth]{figtikz/sb_reduc_serie_1-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{center}
\includegraphics[width=0.5\textwidth]{figtikz/sb_reduc_serie_2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sb_reduc_para_1-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sb_reduc_para_2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\paragraph{La boucle de contre-réaction (positive ou négative)
          \label{sec-boucle}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
La boucle de contre-réaction\footnote{\og Positive or negative feed-back\fg, 
...
composé des différents éléments de bases.
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/boucle-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
Pour cela réécrivons les relations linéaires simples issus de ce schéma-bloc.
On sait que :
%-------------------------------------------------------------------------------
\begin{align}
...
\end{align*}
%-------------------------------------------------------------------------------
On obtient alors la formule de Black
%-------------------------------------------------------------------------------
\begin{marginfigure}
    \centering
    \includegraphics[width=0.9\linewidth]{HaroldBlack.eps}
    \caption*{\index{Black, Harold}\textbf{Harold Stephen Black} (1898-1983) 
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/boucle_eq-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
\newpage
\restoregeometry
...
fonction de transfert de retour (ex: dans le cas présenté précédemment $H_2=1$).
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/boucle_uni-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/dep_comp1-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
Pour pouvoir déplacer le comparateur vers la gauche, 
il faut introduire le bloc $K$ dans la chaîne direct.
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/dep_comp2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/dep_comp3-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/dep_jonc1-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
Il est aisé de déplacer le bloc $K$ devant le point de prélèvement:  
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/dep_jonc2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
de prélèvement. Ainsi les deux schémas-blocs ci-dessous sont équivalents:
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/dep_jonc3-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/reduc_mult1-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
Dans un premier temps, on considère l'entrée $P$ nulle, le schéma-bloc devient :
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/reduc_mult2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/reduc_mult3-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_1-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\'Etape 1}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\'Etape 2}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_3-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_4-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
\`A nouveau il est possible d'identifier une boucle de contre-réaction $B_2$ :
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_5-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{\'Etape 3}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_6-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_7-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_8-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_9-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
La réduction de la boucle de contre réaction interne nous donne :
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/exemple_10-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
est cependant très efficace et trouve de nombreuses applications 
...
ne comporte que deux éléments de base: le \textbf{nœud} et la 
\textbf{branche orientée}. Les nœuds portent les variables du système 
(entrée, sortie, perturbation, commande\ldots). 
Une branche reliant deux nœuds peut être ornée du facteur multiplicatif ou 
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_1-chap_bloc.pdf}
    \[
        S=HE
    \]
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Nous allons considérer le graphe de fluence suivant, pour illustrer 
différentes définitions: 
%-------------------------------------------------------------------------------
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/gf_source-chap_bloc.pdf}
    \caption{Graphe de fluence présentant les différents éléments de bases, 
    types de nœuds et de branches.}
\end{figure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{itemize}
    \item Une \textbf{source} ou nœud d'entrée est un nœud 
          dont toutes les branches sont divergentes. Exemple: le nœud 
          $E$ est une source.
    \item Un \textbf{puits} ou nœud de sortie est un nœud dont toutes 
    les branches sont convergentes. Exemple: le nœud $S$ est un puits.
    ...
    \item Un \textbf{parcours ouvert} est un parcours le long duquel chaque 
          nœud n'est franchi qu'une fois. Exemples: 
          $\{E\rightarrow X_1\rightarrow X_2\rightarrow S\}$, 
          $\{E\rightarrow X_1 \rightarrow S\}$
    \item Un \textbf{parcours fermé} ou \textbf{boucle} est un parcours qui 
          aboutit au nœud dont il est parti, chaque autre nœud n'étant 
...
graphes de fluence.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{1. Addition en un nœud}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
La valeur d'un nœud est égale à la somme de tous les signaux convergeant 
vers ce nœud
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_add-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
S=H_1E_1+H_2E_2
\]
Le comparateur/sommateur présentait précédemment est équivalent au graphe 
de fluence suivant:
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sb_gf-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{2. Distribution par un nœud}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
La valeur d'un nœud est transmise par chaque branche quittant ce nœud
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_distrib-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Un suite de branches en série peut être réduite à une unique branche, dont la 
fonction de transfert est égale au produit des fonctions de transfert des 
diverses branches.
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_branche_serie-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{4. Branche en parallèle}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Deux ou plusieurs branches connectées en parallèle, reliant le même nœud 
d'origine au même nœud extrémité, peuvent être réduites par une branche 
unique, dont la fonction de transfert est égale à la somme des fonctions de 
transfert des diverses branches. 
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_branche_para-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{5. Absorption d'un nœud}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Un nœud qui n'est ni une source ni un puits peut être supprimé de la
manière suivante :
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_absorption-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_boucle1-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
La variable $M$ du graphe de fluence peut être réduit, ce qui donne :
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_boucle2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
Il est possible d'éliminer le nœud porté par la variable $\epsilon$:
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_boucle3-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_boucle4-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_boucle5-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
De la même manière que précédemment, le graphe de fluence se limite à 
deux nœud et deux branches (dont une boucle élémentaire).
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_boucle6-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
le cas d'un système dans une boucle de contre réaction (c.f \Cref{chap-stab}).}
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_boucle7-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
les fonctions de transfert des branches parcourues. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Mason (1921-1974), électronicien américain.}. Cette règle permet de réduire 
...
%-------------------------------------------------------------------------------
        ...
        disjoints, c'est à dire n'ayant aucun nœud en commun.
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_mason1-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
étant toutes disjointes, le déterminant du graphe est donc simplement 
donné par :
\[
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/gf_mason2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
le domaine temporel. Pour cela, nous suivrons et adapterons à nos notations
...
%6-003-signals-and-systems-fall-2011/lecture-videos/MIT6_003F11_lec04.pdf
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Opérateur intégral}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_Int-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_Int_Dirac-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_Int_Echelon-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_IntInt_Dirac-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Nous représentons le produit d'un signal $e(t)$ par un simple scalaire $a$
(c.-à-d. un gain) par un triangle de la façon suivante:
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_BlocT-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_eqdiff2-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\input{re/newgeometry}
\captionsetup{width=0.9\linewidth}
Comme nous l'avons vu précédemment, l'application de l'opérateur 
$\mathcal{I}^n$ revient à appliquer $\mathcal{I}$ $n$ fois.
...
\end{align*}
%-------------------------------------------------------------------------------
où l'on retrouve le développement en série entière de la fonction 
exponentielle. La réponse temporelle $s(t)$\footnote{
...
pris par le signal dans la boucle de contre-réaction (feed-back) 
(c.f ~\cref{fig-cycles}).
Notons au passage que $a$ joue ici le rôle du pôle de la fonction de transfert. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Application au système masse-ressort}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/masse_ressort-chap_slci.pdf}
\end{marginfigure}
%-------------------------------------------------------------------------------
\clearpage
\restoregeometry
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_masse_ressort-chap_bloc.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
Cette représentation peut être plus facile à utiliser par des outils graphiques
permettant de reproduire des schémas fonctionnels directement dans le domaine
temporelle comme Xcos ou MATLAB/Simulink.
\clearpage
%-------------------------------------------------------------------------------
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_cycle1.pdf}
    
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_cycle2.pdf}
    
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_cycle3.pdf}
    
    \includegraphics[width=0.5\textwidth]{figtikz/sbdt_cycle4.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_chap_bloc.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_corriges_chap_bloc.tex}
\normalsize
\restoregeometry
\captionsetup{width=0.9\linewidth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
