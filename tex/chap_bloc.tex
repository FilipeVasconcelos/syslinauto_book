...
pris par le signal dans la boucle de contre-réaction 
(feedback)~\cref{fig-cycles}.
Notons au passage que $a$ joue le rôle du pôle de la fonction de transfert. 
\clearpage
%-------------------------------------------------------------------------------
\begin{figure}[!h]
    \centering
...
présentée au chapitre précédent (c.f \cref{para-masse_ressort}). L'équation 
différentielle reliant la position de la masse $x(t)$ et 
