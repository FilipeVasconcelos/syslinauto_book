...
La seconde instruction est l'énoncé du polynôme utilisant cette indéterminée. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Exemple}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
On utilisera la fonction \texttt{ones} pour construire un vecteur ou 
une matrice remplie de 1.
...
respectivement des vecteurs de valeurs linéairement et logarithmiquement 
équidistantes.  

Par exemple l'instruction suivante construit un vecteur de 9 éléments 
équidistants (de 0.5) dont les valeurs sont comprises entre 1 et 5 :
%-------------------------------------------------------------------------------
\begin{Scilabcode}
--> linspace(1,5,9)
 ans  =
...
\begin{figure}[!hb]
    \centering
    \includegraphics[width=0.8\textwidth]{capture_SCILAB-fonction.eps}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{capture_SCILAB.eps}
...
\end{Scilabcode}
%-------------------------------------------------------------------------------
ou en définissant le numérateur et dénominateur séparément 
...
défini par la fonction \verb?syslin? présentée précédemment 
%-------------------------------------------------------------------------------
\begin{Scilabcode}
...
temps $\Delta t$.
Les instructions suivantes permettent de vérifier cette approximation :
%-------------------------------------------------------------------------------
\begin{Scilabcode}
s=%s
...
\begin{figure}[!b]
    \centering
    \includegraphics[width=0.6\textwidth]{capture_SCILAB-plzr.eps}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/feedback-annexe_scilab.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{itemize}
    ...
    \item Cliquer sur l'icône : \raisebox{-\mydepth}{\fbox{
          \includegraphics[height=\myheight]{xcos.eps}}}
...
Nous allons créer un diagramme simple. Pour cela, placer les blocs suivants 
...
\begin{table}[!h]
    ...
    \begin{minipage}{6cm}
    \centering
    \includegraphics[width=0.25\linewidth]{scilab05.eps}
    \end{minipage} &
    ...
    \begin{minipage}{6cm}
    \centering
    \includegraphics[width=0.25\linewidth]{scilab06.eps}
    \end{minipage} & 
    ...
    \begin{minipage}{6cm}
    \centering
    \includegraphics[width=0.2\linewidth]{scilab07.eps}
    \end{minipage} & 
    Sources / Clock\_c \\
    \midrule
    Visualisation & 
    \begin{minipage}{6cm}
    \centering
    \includegraphics[width=0.25\linewidth]{scilab08.eps}
    \end{minipage} & 
    Sinks / CSCOPE \\
    \bottomrule
\end{tabular}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{diagramme_simple.eps}
...
\raisebox{-\mydepth}{
    \fbox{\includegraphics[height=\myheight]{demarrage.eps}}
}

Pour arrêter une simulation : cliquer sur l'icône : 
\raisebox{-\mydepth}{
    \fbox{\includegraphics[height=\myheight]{stop.eps}}
}
...
\begin{itemize}
    ...
    \item La période d’échantillonnage : Cliquer sur l'horloge.
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.25\textwidth]{FROMWSB.eps}\hspace{3cm}
    \includegraphics[width=0.25\textwidth]{TOWS_c.eps}
...
graphiques.
\scilabcode{scilab/premier_ordre.sce}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
