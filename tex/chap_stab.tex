...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Dans ce chapitre nous allons discuter en détail de la stabilité des systèmes
...
\emph{a priori} on considère  toujours les systèmes dans leur état d'équilibre 
au moment de l'origine des temps (i.e le temps initiale de la sollicitation). 
Une façon imagé de se représenter ces états d'équilibres et d'imaginer le 
mouvement d'une bille sur la surface d'un fonction à une dimension d'énergie 
potentielle, à l'image d'une bille se déplaçant sur un relief accidentés 
composé de collines, vallées et puits de potentiel (c.f \Cref{fig-stab}). 
L'état d'équilibre est ici alors une position d'équilibre.
%-------------------------------------------------------------------------------
\begin{figure}[!h]
    \centering
...
La manière la plus simple de caractériser un équilibre est d'envisager son 
comportement lorsque si l'on modifie légérement sa position par rapport 
à sa position d'équilibre. Dans le cas d'un équilibre stable 
(c.f \Cref{fig-stab} (a)), la bille va naturellement reprendre sa position 
d'équilibre (à noter que dans l'image du puit de potentiel, il est parfaitement 
possible d'envisager une oscillation de la position avant le retour à la 
position d'équilibre). Dans le cas d'un équilibre instable, 
(c.f \Cref{fig-stab} (b)), si on s'écarte (même très faiblement) de la position
d'équilibre, la bille va continuer à s'en écarter indéfiniment. D'autres
scénarios sont possibles mais vont dépendre de la façon dont le système est
déséquilibrée (c.f \Cref{fig-stab} (c)), on parle alors de stabilité 
conditionnelle.

Dans le cas des \gls{slci}, il est possible d'étudier ce comportement
en étudiant la réponse impulsionnelle (c'est à dire la réponse à une impulsion 
de Dirac). Finalement, on définit la stabilité d'un système de la façon 
suivante :
%-------------------------------------------------------------------------------
\begin{definition}{Stabilité d'un système (1)}
\textbf{Un système est dit stable lorsque écarté de son état d'équilibre, il 
tend à y revenir}
\end{definition}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Mise en évidence de l'instabilité de l'asservissement}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    ...
    \input{tikz/instabilite_pompage-non_boucle-chap-stab.tex}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    ...
    \input{tikz/instabilite_pompage-chap-stab.tex}
\end{center}
%-------------------------------------------------------------------------------
...
\]
La suite géométrique présente dans cette expression diverge puisque $K>1$.

\textbf{Il est donc clair que l'asservissement par bouclage peut également 
provoquer l'instabilité de la réponse. Il est donc essentiel d'étudier 
cette propriété dans le cas des systèmes asservis.}

Pour celà, nous allons introduire différents critères permettant
de vérifier si un asservis est stable ou non. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Critère fondamentale de stabilité d'un système asservis}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_ntours_3-chap_stab.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_contours_exemple_1-chap_stab.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_contours_exemple_2-chap_stab.tex}
