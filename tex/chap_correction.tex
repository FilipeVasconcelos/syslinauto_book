...
(c.f \Cref{chap-model}), être précis, rapide (c.f \Cref{chap-perf}), stable 
(c.f \Cref{chap-stab}). Ces performances dépendent essentiellement des 
propriétés de la fonction de transfert de la boucle fermée, 
elles mêmes dépendant de celle de la boucle ouverte. 
%-------------------------------------------------------------------------------
\begin{center}
