...
\begin{center}
    ...
    \input{tikz/routh_exemple-chap7.tex}
\end{center}
...
\begin{center}
    ...
    \input{tikz/sb_revers-chap7.tex}
\end{center}
...
\begin{figure}[!h]
    ...
    \input{tikz/critere_revers_nyquist-chap7.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/critere_revers_black-chap7.tex}
...
\centering
    ...
    \input{tikz/critere_revers_bode-chap7.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Critère de Nyquist\index{Critère de stabilité!Critère de Nyquist}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_cauchy-chap7.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_contours-chap7.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_contours_exemple_1-chap7.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_contours_exemple_2-chap7.tex}
