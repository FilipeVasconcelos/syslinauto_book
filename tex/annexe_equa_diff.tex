...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/solutions_equadiff-annexe_equa_diff.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.47\textwidth]{figtikz/solutions_equadiff_2nd_s1-m10-annexe_equa_diff.pdf}
    \includegraphics[width=0.47\textwidth]{figtikz/solutions_equadiff_2nd_s1-m5-annexe_equa_diff.pdf}
    
    \includegraphics[width=0.47\textwidth]{figtikz/solutions_equadiff_2nd_s1-5-annexe_equa_diff.pdf}
    \includegraphics[width=0.47\textwidth]{figtikz/solutions_equadiff_2nd_s1-10-annexe_equa_diff.pdf}
\end{center}
%-------------------------------------------------------------------------------
