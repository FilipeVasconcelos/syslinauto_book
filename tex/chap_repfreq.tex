...
\end{bequation}
%-------------------------------------------------------------------------------
Un intégrateur pur déphase donc la sortie de -90\degree~quelque soit la pulsation
de l'entrée.
%-------------------------------------------------------------------------------
\begin{figure}[!htb]
    \centering
...
\end{bequation}
%-------------------------------------------------------------------------------
Le déphasage d'un retard pur croit linéairement avec la pulsation pour un retard 
de temps $\tau$ donné.
%-------------------------------------------------------------------------------
\begin{figure}[!htb]
    \centering
...
%        \end{itemize}
%-------------------------------------------------------------------------------
%    \item un terme $(1+2\xi_j\tau_jp+\tau_j^2p^2)$ (i.e second ordre au 
