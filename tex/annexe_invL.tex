...
largement de la précision machine accessible pour le calcul 
en virgule flottante. L'usage de librairie en précision arbitraire 
comme \texttt{mpmath} peut être 
...
\begin{figure}[!hb]
    ...
    relative de chacune des deux approches avec la réponse 
    temporelle exacte calculée avec la fonction 
    \texttt{premier\_ordre}.~\label{fig-1erOrdreInvL}}
\end{figure}
%-------------------------------------------------------------------------------
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!hb]
    ...
    \caption{Même présentation que~\cref{fig-1erOrdreInvL} dans le cas 
