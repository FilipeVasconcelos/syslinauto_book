\begin{landscape}
    ...
    \raisebox{-.5\height}{\resizebox{\linewidth}{!}{\input{1-1.tex}}} 
    $$s(t)=\dfrac{1}{\tau_1-\tau_2}\left(e^{-\frac{t}{\tau_1}}-e^{-\frac{t}{\tau_2}}\right)$$ &
    \raisebox{-.5\height}{\resizebox{\linewidth}{!}{\input{1-2.tex}}} 
    {\mysize $$s(t)=\dfrac{t}{\tau^2}e^{-\frac{t}{\tau}}$$} &  
    \raisebox{-.5\height}{\resizebox{\linewidth}{!}{\input{1-3.tex}}} 
    {\mysize $$s(t)=\dfrac{\omega_d}{1-\xi^2}e^{-\xi\omega_0 t}\sin{\omega_d t}$$}\\
    \midrule
    Réponse indicielle &  
    \raisebox{-.5\height}{\resizebox{\linewidth}{!}{\input{2-1.tex}}} 
    {\mysize $$s(t)=1+\dfrac{1}{\tau_1-\tau_2}\left(\tau_2e^{-\frac{t}{\tau_2}}-\tau_1e^{-\frac{t}{\tau_1}}\right)$$} &  
    \raisebox{-.5\height}{\resizebox{\linewidth}{!}{\input{2-2.tex}}} 
    {\mysize $$s(t)=1-e^{-\frac{t}{\tau}}-\dfrac{t}{\tau}e^{-\frac{t}{\tau}}$$ } &  
    \raisebox{-.5\height}{\resizebox{\linewidth}{!}{\input{2-3.tex}}} 
