...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Les critères de stabilité graphiques sont des critères qualitatifs, c'est à dire
que l'on peut s'assurer qu'un système est stable ou instable (ou à la limite 
de la stabilité). Pour quantifier, la distance à la limite de stabilité c'est 
à dire au point critique, nous définissons les marges de stabilité 
(en phase et en gain). Ces marges de stabilités sont en générales imposées par
...
$G_{\si{\dB}}(\omega_{c0})=20\log{|H_{BO}(j\omega_{c0})|}=\SI{0}{\dB}$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\omega_{\pi}$ est la pulsation pour laquelle le déphasage vaut \SI{-180}{\degree}
$\phi(\omega_\pi)=\arg{(H_{BO}(j\omega_{c0}))}=-\pi$
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{nyquist_contours-chap_stab-ext}
    \input{tikz/nyquist_contours-chap_stab.tex}
