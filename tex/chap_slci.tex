...
\tikzstyle{signal}=[thick,domain=0:30,samples=201]
\begin{tikzpicture}
\begin{axis}[%
...
\addplot[black,signal] {1};
\addplot[cyan,signal ] {6.25*(1-exp(-x/5))-1.25*(1-exp(-x))};
\addplot[green,signal] {1.25*(1-exp(-x))};
\addplot[blue,signal ] {6.25*(1-exp(-x/5))};
