...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.7\textwidth]{pid_parallele_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.7\textwidth]{pid_serie_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
...
\hline
Correcteur & $C(p)$ & Classe & Précision statique & Dynamique / stabilité \\
\hline
P      & $K$ & = & améliorée & rapidité ↑, stabilité ↓ si $K$ ↑ \\
I      & $\dfrac{K}{p}$ & +1 & erreur indicielle nulle 
       & lenteur ↑, stabilité ↓ \\
D      & $Kp$ & = & = & amortissement ↑, stabilité ↑, bruit ↑ \\
PI     & $K\!\left(1+\dfrac{1}{T_i p}\right)$ & +1 & erreur indicielle nulle 
       & compromis précision / stabilité \\
PD     & $K(1+T_d p)$ & = & améliorée & amortissement ↑, rapidité ↑, bruit ↑ \\
PID    & $K\!\left(1+\dfrac{1}{T_i p}+T_d p\right)$ & +1 & 
      erreur indicielle nulle & performances globales ↑, bruit ↑ \\
Retard & $K\dfrac{1+Tp}{1+\alpha Tp},\,\alpha>1$ & = & améliorée & 
      rapidité ↓, stabilité ↓ \\
Avance & $K\dfrac{1+Tp}{1+\alpha Tp},\,0<\alpha<1$ & = & = 
       & rapidité ↑, stabilité ↑ \\
\hline
\end{tabular}
\end{center}
