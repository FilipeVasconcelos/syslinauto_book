%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\exercice{Représentation graphique d'un signal harmonique}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    ...
    \input{tikz/sollicitation_harmonique-exercices_corriges-chap_repfreq.tex}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    ...
    \input{tikz/reponse1_harmonique-exercices_corriges-chap_repfreq.tex}
\end{center}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{center}
    ...
    \input{tikz/reponse2_harmonique-exercices_corriges-chap_repfreq.tex}
\end{center}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{center}
    ...
    \input{tikz/reponse3_harmonique-exercices_corriges-chap_repfreq.tex}
\end{center}
%-------------------------------------------------------------------------------
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\exercice{Diagramme de Bode}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    ...
    \input{tikz/gainQ1-exercices_corriges-chap_repfreq.tex}

    \tikzsetnextfilename{phaseQ1-exercices_corriges-chap_repfreq-ext}
    \input{tikz/phaseQ1-exercices_corriges-chap_repfreq.tex}
\end{center}
...
\begin{center}
    ...
    \input{tikz/gainQ2-exercices_corriges-chap_repfreq.tex}

    \tikzsetnextfilename{phaseQ2-exercices_corriges-chap_repfreq-ext}
    \input{tikz/phaseQ2-exercices_corriges-chap_repfreq.tex}
\end{center}
\paragraph{Fonctions réelles du gain et du déphasage}
\[
G(\omega)=|H(\jw)|=
...
\begin{center}
    ...
    \input{tikz/gainQ3-exercices_corriges-chap_repfreq.tex}

    \tikzsetnextfilename{phaseQ3-exercices_corriges-chap_repfreq-ext}
    \input{tikz/phaseQ3-exercices_corriges-chap_repfreq.tex}
\end{center}
\paragraph{Fonctions réelles du gain et du déphasage}$\,$\newline
\[
G(\omega)=|H(\jw)|=
...
\begin{center}
    ...
    \input{tikz/gainQ4-exercices_corriges-chap_repfreq.tex}

    \tikzsetnextfilename{phaseQ4-exercices_corriges-chap_repfreq-ext}
    \input{tikz/phaseQ4-exercices_corriges-chap_repfreq.tex}
\end{center}
...
\begin{center}
    ...
    \input{tikz/gainQ5-exercices_corriges-chap_repfreq.tex}
    
    \tikzsetnextfilename{phaseQ5-exercices_corriges-chap_repfreq-ext}
    \input{tikz/phaseQ5-exercices_corriges-chap_repfreq.tex}
\end{center}
\paragraph{Fonctions réelles du gain et du déphasage}
\[
G(\omega)
