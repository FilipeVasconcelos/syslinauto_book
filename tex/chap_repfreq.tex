...
Comme nous venons de le montrer la réponse harmonique est complètement 
...
\begin{marginfigure}[-20em]
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/repham_1-chap_repfreq.pdf}}
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/repham_2-chap_repfreq.pdf}}
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/repham_3-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{HendrikBode.eps} 
...
logarithmique pour permettre la représentation de la réponse harmonique sur 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{figtikz/sche_bode-chap_repfreq.pdf}
...
\begin{figure}[!b]
    \centering
    \resizebox{.45\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/sche_nyquist_3-chap_repfreq.pdf}}
    \resizebox{.45\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/sche_nyquist_4-chap_repfreq.pdf}}
    \caption{(gauche) Représentation schématique d'un diagramme de Nyquist. 
             ...
             complet de Nyquist, symétrique par rapport à l'axe des réels.
...
\begin{marginfigure}[2em]
    \centering
    \includegraphics[width=\linewidth]{HarryNyquist} 
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\linewidth]{NathanielNichols.eps} 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/sche_black-chap_repfreq.pdf}
...
Dans la pratique, on ne s'intéresse qu'aux limites aux basses et hautes 
...
\begin{itemize}
    ...
    \item[iv)] \'Etablir la fonction de la phase $\phi(\omega)$ à partir de 
        ...
        dans $[-\pi,\pi]$. On se reportera à l'\Cref{annexe-NC} pour plus 
        de détails.}
    \item[v)] Si les fonctions $G(\omega)$ et $\phi(\omega)$ ne sont pas de 
          simples constantes, réaliser une étude
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_gain_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_gain_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_integ_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_integ_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_deriv_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_deriv_2-chap_repfreq.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_retard_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_retard_2-chap_repfreq.pdf}
...
\end{bequation}
%-------------------------------------------------------------------------------
et la phase est simplement donnée par la fonction tangente réciproque:
%-------------------------------------------------------------------------------
\begin{bequation}[ams align]
...
Pour cela, nous introduisons une \textbf{fréquence de cassure} 
$\omega_c=\frac{1}{\tau}$ qui délimite ces deux domaines.
\`A cette fréquence, le gain en décibel est de $G_{dB}(\omega_c)=20\log{K}-3$ 
et la phase $\phi(\omega)=\arctan{(1)}=\frac{\pi}{4}$.
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_1er_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_1er_2-chap_repfreq.pdf}
    \caption{\textbf{Effet du gain $K$.} Diagramme de Bode d'un système du premier ordre 
             (\Cref{eq-1er_ftjw}) avec (noir) $K=0.1$ (bleu) $K=1$ et 
             (rouge) $K=10$. L'effet de $K$ est de décaler verticalement 
             le diagramme de gain.\label{fig-bode_1er_1}}
\end{figure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{figure}[!b]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_1er_3-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_1er_4-chap_repfreq.pdf}
    \caption{\textbf{Effet du temps caractéristique $\tau$.} 
             Diagramme de Bode d'un système du premier ordre 
             (\Cref{eq-1er_ftjw}) avec (noir) $\tau=10$ (bleu) $\tau=1$ et 
             (rouge) $\tau=0.1$. L'effet de $\tau$ est de décaler 
             horizontalement le diagramme de phase.
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.7\textwidth]{figtikz/bode_1er_5-chap_repfreq.pdf}

\includegraphics[width=0.7\textwidth]{figtikz/bode_1er_6-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_1er_serie_2nd_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_1er_serie_2nd_2-chap_repfreq.pdf}
...
\end{bequation}
%-------------------------------------------------------------------------------
et la phase par l'argument principale:
%-------------------------------------------------------------------------------
\begin{bequation}[ams align*]
    \phi(\omega)=
    \begin{cases}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/bode_2nd_1-chap_repfreq.pdf}

    \includegraphics[width=0.7\textwidth]{figtikz/bode_2nd_2-chap_repfreq.pdf}
...
\begin{figure}[!t]
    \centering
    %\includegraphics[width=0.5\textwidth]{figtikz/bode_2nd_3-chap_repfreq.pdf}

    %\includegraphics[width=0.5\textwidth]{figtikz/bode_2nd_4-chap_repfreq.pdf}
...
résonance est le plus intense (c.f Figure \cref{fig-gain_2nd}).
...
\begin{figure}[!htb]
    ...
    \caption{\'Evolution du gain maximal à la pulsation de résonance
             $\omega_r$ pour différentes valeurs 
             du taux d'amortissement $\xi$. Notons l'utilisation 
...
\input{tex/tab_bode_1.tex}
}
\end{center}
\clearpage
\begin{center}
{\tikzset{external/export=false}
\input{tex/tab_bode_2.tex}
}
\end{center}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/bode_exemple_1-chap_repfreq.pdf}

    \includegraphics[width=0.8\textwidth]{figtikz/bode_exemple_2-chap_repfreq.pdf}
...
\begin{marginfigure}
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/nyquist_contour-chap_repfreq.pdf}
...
l'axe des réels et d'inverser le sens de la flèche pour obtenir le sens de la 
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/nyquist_gainpur-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/nyquist_integ-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/nyquist_deriv-chap_repfreq.pdf}}
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/nyquist_retard-chap_repfreq.pdf}}
    \caption{Diagramme de Nyquist d'un retard pur. Le lieu de Nyquist 
             est représenté par le cercle unité dans le plan complexe.
             \label{fig-nyquist_4}}
\end{marginfigure}
%-------------------------------------------------------------------------------
Les parties réelles et imaginaires sont simplement données par :
%-------------------------------------------------------------------------------
\begin{align*}
...
\begin{figure}[!hb]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/nyquist_1er-chap_repfreq.pdf}
...
\end{align*}
%-------------------------------------------------------------------------------
La \cref{fig-nyquist_2nd_1} présente les tracés des lieux de Nyquist 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/nyquist_2nd_1-chap_repfreq.pdf}
    \includegraphics[width=0.47\textwidth]{figtikz/nyquist_2nd_3-chap_repfreq.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/nyquist_effet_retard_1-chap_repfreq.pdf}
...
%\begin{figure}[!h]
%    \centering
%    \includegraphics[width=0.5\textwidth]{figtikz/nyquist_effet_retard_2-chap_repfreq.pdf}
...
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Synthèse des contributions élémentaires}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Les diagrammes de Nyquist des systèmes usuels peuvent être construits en
combinant les contributions de fonctions de transfert élémentaires. Chaque
terme influence de manière caractéristique le module et l'argument de la
fonction de transfert lorsque la pulsation $\omega$ varie de $0$ à
$+\infty$.

Le~\cref{tab:nyquist_resume} synthétise les variations asymptotiques du
module et de l'argument pour les principaux termes rencontrés en automatique.
Il constitue un outil pratique permettant :

\begin{itemize}
    \item de tracer rapidement un diagramme de Nyquist sans calcul détaillé,
    \item de prévoir la forme générale du lieu de Nyquist,
    \item d'interpréter l'effet de chaque pôle, zéro ou retard,
    \item d'analyser qualitativement la stabilité d'un système bouclé.
\end{itemize}

Plus généralement, le diagramme de Nyquist d'une fonction de transfert
quelconque s'obtient en combinant ces effets élémentaires, le module étant le
produit des modules et l'argument étant la somme des arguments.
\begin{center}
    \begin{tabular}{P{4cm}P{3cm}P{3cm}}
    \hhline{===}
    $H(\jw)$ & $|H(\jw)|$ & $\arg{H(\jw)}$\\[1em]
    \hhline{===}
    $\dfrac{1}{\jw}$ & $\infty\rightarrow 0$ & $-\dfrac{\pi}{2}$\\[1em]
    \hline
    $\dfrac{1}{1+\jtw}$ & $1\rightarrow0$ & $0\rightarrow-\dfrac{\pi}{2}$\\[1em]
    \hline
    $\dfrac{1}{(1-\tau^2_n\omega^2)+j2\xi\tau_n\omega}$ & $1\rightarrow0$ & $0\rightarrow-\pi$\\[1em]
    \hline
    $e^{-\jtw}$ & 1 & $0\rightarrow\infty$\\[1em]
    \hline
    $1+\jtw$ & $1\rightarrow\infty$& $0\rightarrow\dfrac{\pi}{2}$\\[1em]
    \hline
    $\dfrac{1}{1-\jtw}$ & $1\rightarrow0$& $0\rightarrow\dfrac{\pi}{2}$\\[1em]
    \hline
    $1-\jtw$ & $1\rightarrow\infty$& $0\rightarrow-\dfrac{\pi}{2}$\\[1em]
    ...
    \hhline{===}
    \end{tabular}
    \captionof{table}{Variation du module et de l'argument du nombre 
                      complexe $H(\jw)$ lorsque $\omega$ varie de $0\rightarrow\infty$\label{tab:nyquist_resume}}
\end{center}
\clearpage
\input{re/newgeometry}
\captionsetup{width=0.9\linewidth}
...
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Diagramme de Black d'un intégrateur pur}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/black_integ-chap_repfreq.pdf}}
...
de \SI{-90}{\degree} à toutes pulsations et que le gain diminue lorsque la
pulsation augmente.
...
connaître la pulsation qui donne un gain de \SI{0}{\dB}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Diagramme de Black d'un dérivateur pur}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{marginfigure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics[width=\textwidth]{figtikz/black_deriv-chap_repfreq.pdf}}
...
\captionsetup{width=0.9\linewidth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Diagramme de Black d'un premier ordre}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/black_1er-chap_repfreq.pdf}
    \caption{Diagramme de Black d'un système du premier ordre. 
    \label{fig-black_3}}
\end{figure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Diagramme de Black d'un second ordre}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.45\textwidth]{figtikz/black_2nd-chap_repfreq.pdf}
    \includegraphics[width=0.45\textwidth]{figtikz/black_2nd_resonance-chap_repfreq.pdf}
    \caption{Diagramme de Black d'un système du second ordre (à gauche)
        pour $\xi=1$ (à droite) pour différentes valeurs de 
        $\xi<\dfrac{\sqrt{2}}{2}$ (phénomène de résonance). 
    \label{fig-black_4}}
\end{figure}
%-------------------------------------------------------------------------------
%\clearpage
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Étude du transitoire de la réponse harmonique}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\acplhp
%c.f pdf/[AnaHSLCI][CO]Analyse_harmonique_des_SLCI.pdf
L'objectif principal de ce chapitre était de présenter le régime permanent
de la réponse harmonique, c'est pourquoi nous avons délibérément occulté 
...
transitoire. Comme attendu le régime transitoire a une durée corrélée aux temps
caractéristiques des systèmes du premier ordre $\tau$.
%-------------------------------------------------------------------------------
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\textwidth]{figtikz/repham_transitoire_1er-chap_repfreq.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_chap_repfreq.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_corriges_chap_repfreq.tex}
\normalsize
\restoregeometry
\captionsetup{width=0.9\linewidth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
