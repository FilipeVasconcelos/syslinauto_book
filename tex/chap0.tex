...
nous représenterons par un bloc de la façon suivante :
\begin{center}
...
dépendants du temps. 
Cette représentation dite en bloc sera généralisée au~\Cref{chap-schemabloc}.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Système à temps continu}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{Un système à temps continu met en oeuvre des signaux 
à temps continus}. Comme nous le verons, ces signaux seront
...
\begin{itemize}
    \item \emph{Principe de superposition :}
     \textbf{Si l'entrée du système se décompose en une combinaison 
        somme de plusieurs entrées alors la sortie du système sera la somme des 
