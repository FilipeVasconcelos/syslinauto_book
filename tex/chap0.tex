...
À l'aide d'un schéma-bloc, un système invariant $\Sigma$ devient : 
\begin{center}
...
Il existe des méthodes numériques pour déterminer la fonction image de la transformée 
de Laplace inverse, ces méthodes sont cependant hors programme, mais cependant discuté en \cref{annexe-invL}
