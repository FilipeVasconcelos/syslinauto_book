...
\begin{landscape}
    ...
    \begin{figure}[!h]
        ...
        \end{axis}
            ...
            \node[anchor=south west] at (pt1) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black!60!green,domain=0:10, samples=501,unbounded coords=jump]{1.2*sin(4.5*deg(x))*exp(-0.7*x)+1};
            ...
            \node[anchor=south west] at (pt2) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black!10!green,domain=0:10, samples=501,unbounded coords=jump]{1.2*sin(2.5*deg(x))*exp(-0.5*x)+1};
        ...
        \end{tikzpicture}
    \caption{Stabilité d'un SLCI d'après la carte des pôles de sa fonction de transfert. 
