...
\begin{axis}
    ...
    \def\xt{-1}
    \def\yt{-4}
    \addplot [-{Latex[length=3mm]},col3,very thick,domain=0.85:0.55,samples=51]
    ({(1-x)*((1-x)*(x*\xu)+x*((1-x)*\xu+x*\xd))+
    x*((1-x)*((1-x)*\xu+x*\xd)+x*((1-x)*\xd+x*\xt))},
    {(1-x)*((1-x)*(x*\yu)+x*((1-x)*\yu+x*\yd))+
    x*((1-x)*((1-x)*\yu+x*\yd)+x*((1-x)*\yd+x*\yt))});
    \addplot [-{Latex[length=3mm]},col3,very thick,domain=0.56:0.3,samples=50]
    ({(1-x)*((1-x)*(x*\xu)+x*((1-x)*\xu+x*\xd))+
    x*((1-x)*((1-x)*\xu+x*\xd)+x*((1-x)*\xd+x*\xt))},
    {(1-x)*((1-x)*(x*\yu)+x*((1-x)*\yu+x*\yd))+
    x*((1-x)*((1-x)*\yu+x*\yd)+x*((1-x)*\yd+x*\yt))});
    \addplot [col3,thick,very thick,domain=0.31:0,samples=50]
    ({(1-x)*((1-x)*(x*\xu)+x*((1-x)*\xu+x*\xd))+
    x*((1-x)*((1-x)*\xu+x*\xd)+x*((1-x)*\xd+x*\xt))},
    {(1-x)*((1-x)*(x*\yu)+x*((1-x)*\yu+x*\yd))+
    x*((1-x)*((1-x)*\yu+x*\yd)+x*((1-x)*\yd+x*\yt))});

    \draw[dashed,thick] (axis cs: 0,0) circle [radius=3.2cm];
    ...
    \node[col1,text width=6cm] at (axis cs: 1.19,1.15) 
