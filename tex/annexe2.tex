...
par rapport à l'axe des réels (\Cref{fig-plan_complexe}).
...
\begin{axis}
    [
%    ytick ={-7,...,8}, 
    %yticklabels={$-7i$, $-6i$, $-5i$, $-4i$, $-3i$, $-2i$, $-i$, $0$, $i$, $2i$, $3i$, $+3i$, $+4i$, $+5i$, $+6i$, $+7i$, $+8i$},
    axis lines = center,
%    grid=both,
    minor tick num=1,
    ticks=both,
...
%    grid=both,
    ...
    %\draw(axis cs:0,0) circle[red, radius=3.6055];
