...
\begin{axis}[
    ...
    \node[left,red]  at (axis cs:-0.05,0.05) {\textbf{II}};
\end{axis}
\end{tikzpicture}
...
\begin{axis}[
    ...
    xmax=2.4,
    clip=false]
    \draw[dashed,blue,very thick,-{Latex[length=2.5mm]}] (axis cs:0,-1.4) -- (axis cs:0,-0.7) ;
