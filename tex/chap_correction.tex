...
\begin{figure}[!b]
    \centering
    \includegraphics[width=0.8\textwidth]{figtikz/necessite_correction_chap_correction.pdf}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.4\textwidth]{figtikz/bs_correction_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/correction_serie_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/correction_reaction_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/correction_serie-reaction_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
%\[
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.4\textwidth]{figtikz/p_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{itemize}
    \item \textbf{Module} :
    \[
        \left|C_{\text{P}}(j\omega)\right|=k_p\quad\text{ou}\quad\left|C_{\text{P}}(j\omega)\right|_{dB}=20\log k_p
    \]
    \item \textbf{Phase} :
    \[
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.37\textwidth]{figtikz/bode_p_gain_chap_correction.pdf}
    \includegraphics[width=0.37\textwidth]{figtikz/bode_p_phase_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
En ce qui concerne, l'erreur statique est simplement réduite lorsque $k_p$ augmente, 
sans toutefois pouvoir être annulée (sauf si le système possède déjà un intégrateur).

Il existe donc un compromis entre précision et stabilité : \textbf{augmenter $k_p$ 
améliore la précision, mais peut dégrader la stabilité et conduire à des oscillations.}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.4\textwidth]{figtikz/i_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.37\textwidth]{figtikz/bode_i_gain_chap_correction.pdf}
    \includegraphics[width=0.37\textwidth]{figtikz/bode_i_phase_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.4\textwidth]{figtikz/d_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.37\textwidth]{figtikz/bode_d_gain_chap_correction.pdf}
    \includegraphics[width=0.37\textwidth]{figtikz/bode_d_phase_chap_correction.pdf}
\end{center}
...
Cependant, le gain devenant très élevé aux hautes fréquences, le correcteur dérivé
amplifie fortement les signaux rapides, notamment le bruit de mesure. Il ne peut
donc pas être utilisé seul en pratique.
...
Il amplifierait infiniment les composantes haute fréquence, notamment le bruit de mesure.
...
\og D filtré\fg, en effet l'action du terme $\dfrac{1}{1+\tau p}$ est celui d'un filtre
passe-bas.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
est équivalente et ne nécessite qu'une redéfinition des paramètres du correcteur}
%-------------------------------------------------------------------------------
\begin{center}
     \includegraphics[width=0.6\textwidth]{figtikz/pi_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{itemize}
    ...
    À basse fréquence $(\omega \ll \dfrac{1}{\tau_i})$, le comportement est celui
    d'un intégrateur :
    \[
    ...
    La phase évolue donc progressivement entre $-\dfrac{\pi}{2}$ et $0$ autour de la
    pulsation de coupure $\omega_i=\dfrac{1}{\tau_i}$.
\end{itemize}
%-------------------------------------------------------------------------------
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/bode_pi_gain_chap_correction.pdf}
    
    \includegraphics[width=0.47\textwidth]{figtikz/bode_pi_phase_chap_correction.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/bode_pd_gain_chap_correction.pdf}
    
    \includegraphics[width=0.47\textwidth]{figtikz/bode_pd_phase_chap_correction.pdf}
    \caption{Diagramme de Bode du correcteur à effet proportionnel et dérivé.}
\end{figure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/pd_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
...
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/bode_avancedephase_gain_chap_correction.pdf}
    
    \includegraphics[width=0.47\textwidth]{figtikz/bode_avancedephase_phase_chap_correction.pdf}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/reponse_indicielle_exempleAP_NC-chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.8\textwidth]{figtikz/bode_BONC_exempleAP-chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.8\textwidth]{figtikz/bode_BONC_BOC_exempleAP-chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/reponse_indicielle_exempleAP_C_NC-chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/bode_retarddephase_gain_chap_correction.pdf}
    
    \includegraphics[width=0.47\textwidth]{figtikz/bode_retarddephase_phase_chap_correction.pdf}
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.7\textwidth]{figtikz/pid_parallele_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.7\textwidth]{figtikz/pid_serie_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.7\textwidth]{figtikz/pid_mixte_chap_correction.pdf}
\end{center}
%-------------------------------------------------------------------------------
\[
...
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/bode_retardavancedephase_gain_chap_correction.pdf}
    
    \includegraphics[width=0.47\textwidth]{figtikz/bode_retardavancedephase_phase_chap_correction.pdf}
...
I   & $\dfrac{K}{p}$ & +1 & erreur indicielle nulle & lenteur ↑, stabilité ↓ \\
D   & $Kp$ & = & = & amortissement ↑, stabilité ↑, bruit ↑ \\
PI  & $K\!\left(1+\dfrac{1}{T_i p}\right)$ & +1 & erreur indicielle nulle & compromis précision / stabilité \\
PD  & $K(1+T_d p)$ & = & améliorée & amortissement ↑, rapidité ↑, bruit ↑ \\
PID & $K\!\left(1+\dfrac{1}{T_i p}+T_d p\right)$ & +1 & erreur indicielle nulle & performances globales ↑, bruit ↑ \\
Retard & $K\dfrac{1+Tp}{1+\alpha Tp},\,\alpha>1$ & = & améliorée & rapidité ↓, stabilité ↓ \\
Avance & $K\dfrac{1+Tp}{1+\alpha Tp},\,0<\alpha<1$ & = & = & rapidité ↑, stabilité ↑ \\
\hline
\end{tabular}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
