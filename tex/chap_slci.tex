...
\begin{figure}[!h]
    ...
    \input{tikz/systeme-chap_slci.tex}
...
\begin{center}
    ...
    \input{tikz/sb_bloc-chap_slci.tex}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
        \begin{center}
            ...
            \input{tikz/principe_superposition_1-chap_slci.tex}
        \end{center}
%-------------------------------------------------------------------------------
...
\begin{marginfigure}[-8em]   
    ...
    \input{tikz/decharge_condensateur-chap_slci.tex}
...
\begin{figure}[!htb]
    ...
    \input{tikz/periodique-chap_slci.tex}
\end{figure}
%-------------------------------------------------------------------------------
...
\begin{figure}[!ht]
    ...
    \input{tikz/instable_echelon-chap_slci.tex}

    \tikzsetnextfilename{entree_harm-chap_slci_ext}
    \input{tikz/entree_harm-chap_slci.tex}
    ...
    \input{tikz/instable_harm-chap_slci.tex}
...
\begin{marginfigure}
    ...
    \input{tikz/rampe-chap_slci.tex}
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/exp_dec-chap_slci.tex}}
...
\begin{center}
    ...
    \input{tikz/sb_bloc_FT-chap_slci.tex}
\end{center}
%-------------------------------------------------------------------------------
