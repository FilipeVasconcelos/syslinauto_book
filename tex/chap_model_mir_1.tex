...
La transformée de Laplace inverse de $S(p)$ (c.f ligne 7 de la table des                                     transformées de Laplace), nous donne la forme générale de la réponse impulsionnelle 
...
La transformée de Laplace inverse de $S(p)$ (c.f ligne 11 de la table des                                     transformées de Laplace), nous donne la forme générale de la réponse 
...
Le tableau sous la figure~\cref{fig-1er_ind} donne quelques valeurs particulières de la réponse 
