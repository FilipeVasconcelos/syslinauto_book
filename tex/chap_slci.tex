...
et la réponse impulsionnelle paraît évident. En effet, pour une impulsion de Dirac 
en entrée, la réponse impulsionnelle est simplement donnée par la fonction 
...
dans le domaine de Laplace. Autrement dit, si $h(t)$ est la réponse 
