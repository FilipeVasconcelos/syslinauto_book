...
\begin{tikzpicture}
   ...
   width=5cm,
      axis x line=center,
        ...
        \addplot [very thick,color=red,const plot]   
        coordinates { (-1, 0.01) (0, 0.01) (0 ,1)  (5,1) };
        \addplot [very thick,color=green,const plot] 
...
\paragraph{\textbf{(1) $\devi{s(t)}{} + 2s(t) = e(t) $
avec $s(0)=2$ et $e(t) = e^{-t}$}}
...
\tikzsetnextfilename{exercice_7_corrige-chap0-ext}
    \begin{tikzpicture}
        ...
        \addplot [very thick,color=blue,domain=0:10, samples=501]
        {exp(-x)+exp(-2*x)};
        \addplot [very thick,color=black,domain=0:10, samples=501]{exp(-x)};
        \end{axis}
    \end{tikzpicture}
\end{center}

\newpage
\paragraph{\textbf{(2) $\devi{s(t)}{2} + 3 \devi{s(t)}{} + 2s(t)=
...
\newpage
\paragraph{\textbf{(3) $\devi{s(t)}{2} + 2\devi{s(t)}{} + s(t)=e(t)$ 
...
\begin{tikzpicture}
        ...
        \addplot [very thick,color=red,domain=0:4, samples=101]{0.25*x};
        \addplot [very thick,color=red,domain=4:8, samples=101]{-0.25*x+2};
        \addplot [very thick,color=red,domain=8:20, samples=101]{0.01};
        \addplot [very thick,color=green,domain=-2:8, samples=101]{-0.01};
        \addplot [very thick,color=green,domain=8:12, samples=101]{-0.25*x+2};
        \addplot [very thick,color=green,domain=12:16, samples=101]{0.25*x-4};
