...
\centering
\input{fig/cover}
%\includegraphics[width=1.1\paperwidth,keepaspectratio]{fig/wall.eps}%
\vfill
%\includegraphics[width=\paperwidth]{fig/wall2.eps}%
%\includegraphics[width=0.5\paperwidth,keepaspectratio]{fig/wall3.eps}%
}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tikzset{%
