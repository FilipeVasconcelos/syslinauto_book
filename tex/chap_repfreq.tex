...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Pour chacuns des modèles usuels, à savoir : un gain pur, un intégrateur pur,
...
\begin{itemize}
    \item Définir la fonction de transfert complexe $H(\jw)$ du modèle,
    \item \'Etablir le gain en décibel $G_dB(\omega)$ et 
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/black_1er-chap_repfreq.tex}}
...
\begin{marginfigure}
    ...
    \resizebox{\linewidth}{!}{\input{tikz/black_2nd-chap_repfreq.tex}}
