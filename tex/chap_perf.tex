...
\begin{center}
    ...
    \input{tikz/sb_bloc2-chap_perf.tex}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}
    ...
    \input{tikz/reduc_mult1-chap_perf.tex}
\end{center}
%-------------------------------------------------------------------------------
...
\begin{center}                                                  
    ...
    \input{tikz/pert1-chap_perf.tex}
\end{center}                                                    
%-------------------------------------------------------------------------------
...
\begin{center}                           
    ...
    \input{tikz/pert2-chap_perf.tex}
\end{center}                             
%-------------------------------------------------------------------------------
...
\begin{figure}[!h]
    ...
    \input{tikz/pert1_data-chap_perf.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/pert2_data-chap_perf.tex}
    \caption{Effet de la perturbation sur la réponse temporelle dans le cas
...
\begin{figure}[!h]
    ...
    \input{tikz/rapidite_t5pc_1-chap_perf.tex}
    \tikzsetnextfilename{rapidite_t5pc_2-chap_perf-ext}
    \input{tikz/rapidite_t5pc_2-chap_perf.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/rapidite_tm_1-chap_perf.tex}
    \tikzsetnextfilename{rapidite_tm_2-chap_perf-ext}
    \input{tikz/rapidite_tm_2-chap_perf.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/rapidite_tr_2ndordre-chap_perf.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/rapidite_tr_2ndordre_2-chap_perf.tex}
    \caption{Caractérisation de la rapidité d'un système du second ordre en
             fonction du taux d'amortissement $\xi$: par
             (bleu) le temps de réponse à 5\%,  
...
\begin{marginfigure}
    ...
    \input{tikz/bode_1er_chap_perf.tex} 
