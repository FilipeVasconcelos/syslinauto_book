...
\begin{figure}
    ...
    \includegraphics
    [width=0.5\textwidth]
    {reponse_indicielle_non_corrige-exercices_corriges-chap_correction.pdf}
...
\includegraphics
[width=0.7\textwidth]
{reponse_indicielle_corrigee-exercices_corriges-chap_correction.pdf}
\caption{Réponse indicielle du système en boucle fermée non corrigé 
         et corrigé par les différents régulateurs de 
         l'exercice.~\label{fig-reponses_indicielles}}
\end{figure}
%-------------------------------------------------------------------------------
On a tracé sur la même figure~\ref{fig-reponses_indicielles} en boucle fermée 
de tout les systèmes corrigés et non corrigés de l'exercice. On observe clairement les
