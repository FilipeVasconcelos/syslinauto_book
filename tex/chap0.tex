...
la sortie $s(t)$. 
Cette représentation, dite en \textbf{bloc} ou \textbf{schema-bloc}, 
sera généralisée au~\Cref{chap-schemabloc}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Un signal est par définition le porteur de l'information de la 
...
seront traités lors du cycle ingénieur de cette formation.
...
si ce signal est nul pour tout $t<0$. Autrement dit, 
$$
s(t)=0\,\,\,\,\forall t<0
$$
Exemple :
...
même au bout d'un même intervalle de temps ou periode $T$.
