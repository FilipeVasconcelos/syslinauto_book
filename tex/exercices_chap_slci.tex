...
(i.e $a\to0$).    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\question{Indentifier la solution algébrique $X(p)$ pour une cette solicitation.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\] 
Identifier les paramètres $K$, $\xi$ et $\omega$ en fonction des paramètres 
du problème.}
...
\quad\quad pour \xi<1 \]
Déterminer $x(t)$ la solution temporelle de l'équation différentielle pour une telle
sollicitation.}
