...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.4\textwidth]{figtikz/sb_bloc1-chap_perf.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/sb_bloc2-chap_perf.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.8\textwidth]{figtikz/reduc_mult1-chap_perf.pdf}
\end{center}
%-------------------------------------------------------------------------------
Pour déterminer l'écart, il nous faut déterminer la sortie globale $S(p)$ pour
des entrées multiples (c.f~\Cref{chap-schemabloc}-\cref{sec-bloc_multE}).
...
%-------------------------------------------------------------------------------
\begin{center}                                                  
    \includegraphics[width=0.6\textwidth]{figtikz/pert1-chap_perf.pdf}
\end{center}                                                    
%-------------------------------------------------------------------------------
...
$P(p)=\dfrac{P_0}{p}$. L'erreur due à la perturbation en régime permanent 
est alors :
%-------------------------------------------------------------------------------
\begin{align*}
...
En effet si $\alpha_1=0$, l'erreur due à la perturbation est finie et 
donnée par :
\[
    \begin{cases}
...
%-------------------------------------------------------------------------------
\begin{center}                           
    \includegraphics[width=0.7\textwidth]{figtikz/pert2-chap_perf.pdf}
\end{center}                             
%-------------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Dans un tel cas l'erreur due à la perturbation est donnée par :
\[
\epsilon_P=\lim\limits_{p\to0}p\epsilon_P(p)=
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{figtikz/pert1_data-chap_perf.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{figtikz/pert2_data-chap_perf.pdf}
    \caption{Effet de la perturbation sur la réponse temporelle dans le cas
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/rapidite_t5pc_1-chap_perf.pdf}
    \includegraphics[width=0.47\textwidth]{figtikz/rapidite_t5pc_2-chap_perf.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.47\textwidth]{figtikz/rapidite_tm_1-chap_perf.pdf}
    \includegraphics[width=0.47\textwidth]{figtikz/rapidite_tm_2-chap_perf.pdf}
...
Pour des valeurs de $\xi<1$, il est possible d'approcher le temps de 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/rapidite_tr_2ndordre-chap_perf.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{figtikz/rapidite_tr_2ndordre_2-chap_perf.pdf}
    \caption{Caractérisation de la rapidité d'un système du second ordre en
             fonction du taux d'amortissement $\xi$: par
             (bleu) le temps de réponse à 5\%,  
...
\end{align*}
%-------------------------------------------------------------------------------
En s'appuyant sur l'abaque discuté précédemment, il est possible 
...
\begin{marginfigure}
    \centering
    \includegraphics[width=\textwidth]{figtikz/bode_1er_chap_perf.pdf} 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{figtikz/pole_dominant-chap_perf.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_chap_perf.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{tex/exercices_corriges_chap_perf.tex}
\normalsize
\restoregeometry
\captionsetup{width=0.9\linewidth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
