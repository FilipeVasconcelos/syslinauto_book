...
\begin{tabular}{|M{0.5cm}|M{3.9cm}|M{8.9cm}|}
\hline
    & $F(p)$ & $f(t)=\laplacei{F(p)}$ \\
\hline
    1 & 1 & $\delta(t)$ \tabularnewline
\hline
...
\hline
17 & $\dfrac{(b-a)p}{(p+a)(p+b)}$ & $-ae^{-at}+be^{-bt}$&\\
\hline
...
\hline
26 & $\dfrac{\omega^2}{p(p^2+\omega)}$ & $1-\cos\omega t$&\\
\hline
...
\hline
31 & $\dfrac{\omega^2}{p^2+2\xi\omega p +\omega^2}$ & $\dfrac{\omega}{\sqrt{1-\xi^2}}e^{-\xi\omega t}\sin{\omega\sqrt{1-\xi^2} t}$&\\
\hline
32 & $\dfrac{\omega^2}{p(p^2+2\xi\omega p +\omega^2)}$ & $1-\dfrac{1}{\sqrt{1-\xi^2}}e^{-\xi\omega t}\sin{\omega\sqrt{1-\xi^2}t+\phi}$ avec $\phi=\arccos{\xi}$&\\
\hline
\end{tabular}
}
