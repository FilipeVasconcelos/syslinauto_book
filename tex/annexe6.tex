...
de fréquence \unit{440}{\hertz} est de fréquence  
égale à \unit{880}{\hertz} (noté La3).} lorsque $\alpha=2$ et de \textbf{décade} lorsque $\alpha=10$
