...
\graphicspath{{./fig}
              ...
              {./fig/chap_stab/}
              {./fig/logo}
              {./fig/annexe_blackNichols}
              {./fig/annexe_cauchy}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ------------------------------------------------------------------------------
% includeonly individuel
% ------------------------------------------------------------------------------
%\includeonly{tex/preface}
...
%\includeonly{tex/annexe_seriefourier}
...
%\includeonly{tex/annexe_matlab}         % MATLAB
...
{\tikzset{external/export=false}
    ...
    \include{tex/annexe_matlab}        %K MATLAB
    \include{tex/annexe_log}           %L Echelle log  
}
\include{tex/annexe_invL}              %M Laplace inverse 
\include{tex/annexe_blackNichols}      %N Diagramme de Black-Nichols  
\include{tex/annexe_cauchy}            %O Principe de l'argument Cauchy  
\include{tex/annexe_evans}             %P Lieu d'Evans
%\include{tex/todo}                    %Q TODO
\end{appendices}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\backmatter
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{titlepage}
    ...
    \AtPageLowerLeft{%
        \includegraphics
        [width=\paperwidth,height=\paperheight]{fig/cover/quatrieme_page.eps}%
                    }%
    }
\end{titlepage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
