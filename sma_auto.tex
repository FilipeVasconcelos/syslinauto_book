...
%\includeonly{tex/chap2,tex/annexe1}
%\includeonly{tex/chap2,tex/annexe1,tex/annexe4}
%\includeonly{tex/chap2,tex/chap3}
%\includeonly{tex/chap3}
%\includeonly{tex/annexe1,tex/chap0,tex/chap2,tex/chap4}
%\includeonly{tex/chap1,tex/chap4}
%\includeonly{tex/chap4}
%\includeonly{tex/chap0,tex/annexe1,tex/chap2,tex/chap4}
%\includeonly{tex/chap5}
%\includeonly{tex/chap6}
%\includeonly{tex/annexe1,tex/annexe4}
%\includeonly{tex/annexe2}
%\includeonly{tex/chap0,tex/annexe_equa_diff}
%\includeonly{tex/annexe3}
%\includeonly{tex/annexe4}
%\includeonly{tex/annexe1}
%\includeonly{tex/annexe6}
%\includeonly{tex/chap1,tex/chap4}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{tex/chap0}                    % SLCI
\include{tex/chap1}                    % Diagramme bloc
\include{tex/chap2}                    % Modèles de SLCI
\include{tex/chap3}                    % Réponse Harmonique
\include{tex/chap4}                    % Asservissement
%{\tikzset{external/export=false} 
\include{tex/chap5}                    % Performance
\include{tex/chap6}                    % Stabilité
%} 
\include{tex/chap7}                    % Correction
\include{tex/chap8}                    % Représentation d'état.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
