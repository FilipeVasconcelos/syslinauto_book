...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{repham_1-chap4-ext}
    \input{tikz/repham_1-chap4.tex}
    \tikzsetnextfilename{repham_2-chap4-ext}
    \input{tikz/repham_2-chap4.tex}
    \tikzsetnextfilename{repham_3-chap4-ext}
    \input{tikz/repham_3-chap4.tex}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{sche_bode-chap4-ext}
    \input{tikz/sche_bode-chap4.tex}
...
\begin{figure}[!h]
    \centering
    \tikzsetnextfilename{sche_nyquist_1-chap4-ext}
    \input{tikz/sche_nyquist_1-chap4.tex}
    \hspace{0cm}
    \tikzsetnextfilename{sche_nyquist_2-chap4-ext}
    \input{tikz/sche_nyquist_2-chap4.tex}
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{sche_black-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    clip=false,
...
\begin{figure}[!htb]
\centering
\tikzsetnextfilename{bode_gain_1-chap4-ext}
...
\begin{axis}[
    ...
    \addplot[ultra thick,col5,domain=1e-3:1e3,samples=101]{20*log10(0.1)}; 
    \addplot[ultra thick,col1 ,domain=1e-3:1e3,samples=101]{20*log10(1.0)}; 
    \addplot[ultra thick,col4  ,domain=1e-3:1e3,samples=101]{20*log10(10)}; 
\end{axis}
\end{tikzpicture}

\tikzsetnextfilename{bode_gain_2-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\begin{figure}[!htb]
\centering
\tikzsetnextfilename{bode_integ_1-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\tikzsetnextfilename{bode_integ_2-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\begin{figure}[!htb]
\centering
\tikzsetnextfilename{bode_deriv_1-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\tikzsetnextfilename{bode_deriv_2-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\begin{figure}[!htb]
\centering
\tikzsetnextfilename{bode_retard_1-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
    ...
    \addplot[ultra thick, col1,domain=1e-2:1e3, samples=101] {0};
\end{axis}
\end{tikzpicture}

\tikzsetnextfilename{bode_retard_2-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\begin{figure}[!t]
\centering
\tikzsetnextfilename{bode_1er_1-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\tikzsetnextfilename{bode_1er_2-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\begin{figure}[!b]
\centering
\tikzsetnextfilename{bode_1er_3-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\tikzsetnextfilename{bode_1er_4-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\begin{figure}[!t]
\centering
\tikzsetnextfilename{bode_1er_5-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\tikzsetnextfilename{bode_1er_6-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\begin{figure}[!t]
\centering
\tikzsetnextfilename{bode_1er_serie_2nd_1-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\tikzsetnextfilename{bode_1er_serie_2nd_2-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\begin{figure}[!t]
\centering
\tikzsetnextfilename{bode_2nd_1-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\tikzsetnextfilename{bode_2nd_2-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
...
\begin{figure}[!t]
\centering
\tikzsetnextfilename{bode_exemple_1-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}[
    ticklabel style = {font=\footnotesize},
    width=0.9\textwidth,
...
\tikzsetnextfilename{bode_exemple_2-chap4-ext}
\begin{tikzpicture}[trim axis left]
\begin{axis}
    [
    ticklabel style = {font=\footnotesize},
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_gainpur-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis line style = thick,
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_integ-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis line style = thick,
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_deriv-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis line style = thick,
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_retard-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis line style = thick,
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_1er-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis line style = thick,
    ...
    \addplot[col1, mark = *] coordinates {(0, 0)} {};
    \addplot[col1, mark = *] coordinates {(1, 0)} {};
%    \draw[col1,ultra thick,-latex] (axis cs:  0,  0 ) -- (axis cs:  0, 5 );
%    \draw[col1,ultra thick] (axis cs:  0,  4 ) -- (axis cs:  0, 9 );
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_2nd_1-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis line style = thick,
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_2nd_2-chap4-ext}
\begin{tikzpicture}
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_effet_retard_1-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis line style = thick,
...
\begin{figure}[!h]
\begin{center}
\tikzsetnextfilename{nyquist_effet_retard_2-chap4-ext}
\begin{tikzpicture}
\begin{axis}
    [
    axis line style = thick,
