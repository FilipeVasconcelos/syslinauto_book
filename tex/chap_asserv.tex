...
\begin{marginfigure}
    ...
    \caption*{Dessin d'un régulateur à boules. Les boules en rotation 
              s'élèvent lorsque la vitesse augmente, qui referme la valve 
              d'arrivé de vapeur, ce qui entraîne une diminution de la vitesse 
              de rotation de l'arbre entraînant le régulateur jusqu'à qu'un 
              équilibre entre ces deux effets s'installe.}
\end{marginfigure}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{marginfigure}
    \centering
    \includegraphics[width=0.9\linewidth]{Watt.eps}
    \caption*{\index{Watt, James}\textbf{James Watt}, 
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.4\textwidth]{figtikz/sb_bloc0-chap_asserv.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
    \begin{center}
        \includegraphics[width=0.5\textwidth]{figtikz/sb_bloc1-chap_asserv.pdf}
    \end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figtikz/sb_bloc2-chap_asserv.pdf}
    \end{center}
%-------------------------------------------------------------------------------
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\textwidth]{figtikz/reg_2-chap_asserv.pdf}
...
%\begin{figure}[!hb]
%    \centering
%    \includegraphics[width=0.5\textwidth]{figtikz/reg_1-chap_asserv.pdf}
...
%\begin{figure}[!h]
%    \centering
%    \includegraphics[width=0.5\textwidth]{figtikz/pert-chap_asserv.pdf}
%    \caption{Schéma fonctionnel de l'asservissement d'un système 
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\textwidth]{figtikz/pert_2-chap_asserv.pdf}
    \caption{Schéma fonctionnel de l'asservissement d'un système 
            présentant différents types de perturbations. 
            \label{fig-pert2-chap_asserv}}
\end{figure}
%-------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
    \resizebox{\linewidth}{!}{
        \includegraphics[width=\textwidth]{asser-chap_asserv.pdf}}
...
\]
C'est à dire que, dans le cas d'une contre réaction unitaire, la~\gls{ftbf} 
ne dépend que de la~\gls{ftbo}.
%\newpage %tmp
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.5\textwidth]{figtikz/asser_int-chap_asserv.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/asser_1er-chap_asserv.pdf}
\end{center}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\begin{center}
    \includegraphics[width=0.6\textwidth]{figtikz/asser_2nd-chap_asserv.pdf}
\end{center}
%-------------------------------------------------------------------------------
