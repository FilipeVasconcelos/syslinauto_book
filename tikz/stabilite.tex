        ...
        \end{axis}
            ...
            \node[anchor=south west] at (pt1) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black!60!green,domain=0:10, samples=501]{1.2*sin(4.5*deg(x))*exp(-0.7*x)};
                    \addplot [thick,dotted,color=black,domain=0:10, samples=501]{1.2*exp(-0.7*x)};
                    \addplot [thick,dotted,color=black,domain=0:10, samples=501]{-1.2*exp(-0.7*x)};
                    \end{axis}
                \end{tikzpicture}
            };
            ...
            \node[anchor=south west] at (pt2) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black!10!green,domain=0:10, samples=501]{1.2*sin(2.5*deg(x))*exp(-0.5*x)};
                    \addplot [thick,dotted,color=black,domain=0:10, samples=501]{1.2*exp(-0.5*x)};
                    \addplot [thick,dotted,color=black,domain=0:10, samples=501]{-1.2*exp(-0.5*x)};
                    \end{axis}
                \end{tikzpicture}
            };
            ...
            \node[anchor=south west] at (pt3) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black!30!red,domain=0:10, samples=501]{2*exp(-0.75*x)};
                    \end{axis}
                \end{tikzpicture}
            };
            % pt4
            \node[anchor=south west] at (pt4) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=red,domain=0:10, samples=501]{2*exp(-0.25*x)};
                    \end{axis}
                \end{tikzpicture}
            };
            % pt5
            \node[anchor=south west] at (pt5) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black,domain=0:10, samples=501]{1.5};
                    \end{axis}
                \end{tikzpicture}
            };
            % pt52
            \node[anchor=south west] at (pt52) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black,domain=0:15, samples=501]{1+exp(0.1*x)};
                    \end{axis}
            \end{tikzpicture}
            };
            % pt6
            \node[anchor=south west] at (pt6) {
              ...
              \addplot [very thick,color=black!50!white,domain=0:10, samples=501]{sin(2.5*deg(x))*exp(0.40*x)+1};
              \addplot [thick,dotted,color=black!50!white,domain=0:10, samples=501]{ exp(0.4*x)+1};
              \addplot [thick,dotted,color=black!50!white,domain=0:10, samples=501]{-exp(0.4*x)+1};
                    \end{axis}
                \end{tikzpicture}
            };
            ...
            \node[anchor=south west] at (pt62) {
                \begin{tikzpicture}
                    ...
                    \addplot [very thick,color=black!50!white,domain=0:10, samples=501]{sin(2.5*deg(x))};
                    \end{axis}
                \end{tikzpicture}
            };
            % pt7
            \node[anchor=south west] at (pt7) {
              ...
              \addplot [very thick,color=blue,domain=0:10, samples=501]{sin(2.5*deg(x))*exp(0.40*x)+1};
              \addplot [thick,dotted,color=black,domain=0:10, samples=501]{ exp(0.4*x)+1};
              \addplot [thick,dotted,color=black,domain=0:10, samples=501]{-exp(0.4*x)+1};
                    \end{axis}
              \end{tikzpicture}
            };
            ...
            \node[anchor=south west] at (pt8) {
                \begin{tikzpicture}
                    ...
                    \addplot[very thick,color=orange,domain=0:15,samples=501]{1+exp(0.1*x)};
                    \end{axis}
                \end{tikzpicture}
            };
        \end{tikzpicture}
