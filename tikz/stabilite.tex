...
\begin{figure}[!h]
    ...
    \tikzstyle{colstab}=[white!90!blue]
    \tikzstyle{colinstab}=[white!90!black]
    \tikzstyle{fcolstab}=[fill=white!90!blue]
    ...
    \draw[thickdotted,black!60!green] (axis cs:-11,1.5) -- (axis cs:-11,-1.5) ;

    \coordinate (pt2) at (axis cs:-7,1.0);
    \addplot[marktmp,black!10!green]  coordinates{ (-5,0.5) (-5,-0.5) } ;
    \draw[thickdotted,black!10!green] (axis cs:-5,0.5) -- (axis cs:-5,-0.5) ;
    ...
    \draw[thickdotted,black!50!white] (axis cs:0,-2) to[bend right] (axis cs:0,2);

    \coordinate (pt7) at (axis cs:8.25,2);
    \addplot[marktmp,blue] coordinates{ (11,1.5) (11,-1.5) } ;
    \draw[thickdotted,blue] (axis cs:11,1.5) -- (axis cs:11,-1.5);
    ...
    % pt1
    \tikzstyle{colpt1}=[black!60!green]
    \node[anchor=south west] at (pt1) 
    {
        ...
        \addplot[signal,colpt1,domain=0:6] {1.2*sin(4.5*deg(x))*exp(-0.7*x)};
    ...
    % pt2
    \tikzstyle{colpt2}=[black!10!green]
    \node[anchor=south west] at (pt2) 
    {
        ...
        \addplot[signal,colpt2,domain=0:6] {1.2*sin(2.5*deg(x))*exp(-0.5*x)};
	...
	\addplot [signal,black!30!red,domain=0:6]  {2*exp(-0.75*x)};
	\end{axis}
	\end{tikzpicture}
    };
    % pt4
    \node[anchor=south west] at (pt4) 
    {
        ...
        \addplot [signal,red,domain=0:6] {2*exp(-0.25*x)};
        \end{axis}
        \end{tikzpicture}
    };
    % pt5
    \node[anchor=south west] at (pt5) 
    {
        ...
        \addplot[signal,black,domain=0:6] {1.5};
        \end{axis}
        \end{tikzpicture}
    };
    % pt52
	...
	\addplot[signal,black,domain=0:15] {1+exp(0.1*x)};
        \end{axis}
        \end{tikzpicture}
    };
    % pt6
    \tikzstyle{colpt6}=[black!10!green]
	...
	[   xmin=-0.5,xmax=8,
        ...
        \addplot[signal,colpt6,domain=0:8]  {sin(2.5*deg(x))*exp(0.40*x)+1};
    ...
    \node[anchor=south west] at (pt62) 
    {
        ...
        \addplot[signal,black!50!white,domain=0:6.5] {sin(2.5*deg(x))};
        \end{axis}
        \end{tikzpicture}
	};
    % pt7
	...
	\addplot[signal,blue,domain=0:8]   {sin(2.5*deg(x))*exp(0.40*x)+1};
	\addplot[envelop,domain=0:8] {exp(0.4*x)+1};
	\addplot[envelop,domain=0:8] {-exp(0.4*x)+1};
        \end{axis}
        \end{tikzpicture}
	...
	[   xmin=-0.5,xmax=15,
        ...
        \addplot[signal,orange,domain=0:15] {1+exp(0.1*x)};
        \end{axis}
        \end{tikzpicture}
    };
    \end{tikzpicture}
