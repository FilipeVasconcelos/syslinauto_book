...
\begin{figure}[!h]
    ...
    \input{tikz/sche_black-chap4.tex}
...
\begin{figure}[!htb]
    ...
    \input{tikz/bode_gain_1-chap4.tex}

    \tikzsetnextfilename{bode_gain_2-chap4-ext}
    \input{tikz/bode_gain_2-chap4.tex}
...
\begin{figure}[!htb]
    ...
    \input{tikz/bode_integ_1-chap4.tex}

    \tikzsetnextfilename{bode_integ_2-chap4-ext}
    \input{tikz/bode_integ_2-chap4.tex}
...
\begin{figure}[!htb]
    ...
    \input{tikz/bode_deriv_1-chap4.tex}

    \tikzsetnextfilename{bode_deriv_2-chap4-ext}
    \input{tikz/bode_deriv_2-chap4.tex}
...
\begin{figure}[!htb]
    ...
    \input{tikz/bode_retard_1-chap4.tex}

    \tikzsetnextfilename{bode_retard_2-chap4-ext}
    \input{tikz/bode_retard_2-chap4.tex}
...
\begin{figure}[!t]
    ...
    \input{tikz/bode_1er_1-chap4.tex}

    \tikzsetnextfilename{bode_1er_2-chap4-ext}
    \input{tikz/bode_1er_2-chap4.tex}
...
\begin{figure}[!b]
    ...
    \input{tikz/bode_1er_3-chap4.tex}

    \tikzsetnextfilename{bode_1er_4-chap4-ext}
    \input{tikz/bode_1er_4-chap4.tex}
    \caption{Diagramme de Bode d'un système du premier ordre 
...
\input{tikz/bode_1er_5-chap4.tex}

\tikzsetnextfilename{bode_1er_6-chap4-ext}
\input{tikz/bode_1er_6-chap4.tex}
\caption{Diagramme de Bode d'un système du premier ordre 
...
\begin{figure}[!t]
    ...
    \input{tikz/bode_1er_serie_2nd_1-chap4.tex}

    \tikzsetnextfilename{bode_1er_serie_2nd_2-chap4-ext}
    \input{tikz/bode_1er_serie_2nd_2-chap4.tex}
...
\begin{figure}[!t]
    ...
    \input{tikz/bode_2nd_1-chap4.tex}

    \tikzsetnextfilename{bode_2nd_2-chap4-ext}
    \input{tikz/bode_2nd_2-chap4.tex}
...
\begin{figure}[!t]
    ...
    \input{tikz/bode_exemple_1-chap4.tex}

    \tikzsetnextfilename{bode_exemple_2-chap4-ext}
    \input{tikz/bode_exemple_2-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_gainpur-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_integ-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_deriv-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_retard-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_1er-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_2nd_1-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_2nd_2-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_effet_retard_1-chap4.tex}
...
\begin{figure}[!h]
    ...
    \input{tikz/nyquist_effet_retard_2-chap4.tex}
