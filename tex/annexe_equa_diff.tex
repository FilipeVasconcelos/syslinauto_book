...
aux signaux usuels présentés dans ce document au~\Cref{chap-slci} (c.a.d Impulsion de Dirac, échelon-unité et rampe) .
...
{\tikzset{external/export=false}       
        \begin{tikzpicture}
                ...
                \begin{axis}
                    ...
                    {
                    %\pgfmathsetmacro{\s}{0.0}           
                    \addplot[thin,color=blue,domain=0:\t,samples=101]{\s*exp(-\a*x)+(\b/\a)*(1-exp(-\a*x)} ;
                    }
                \end{axis}
